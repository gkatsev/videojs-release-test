<a name="3.3.2"></a>
## [3.3.2](https://github.com/gkatsev/videojs-release-test/compare/v3.3.1...v3.3.2) (2021-08-18)

### Chores

* fixup env name ([fd518c7](https://github.com/gkatsev/videojs-release-test/commit/fd518c7))
...
* comment ([8373522](https://github.com/gkatsev/videojs-release-test/commit/8373522))
...
* publish as next ([f793fc2](https://github.com/gkatsev/videojs-release-test/commit/f793fc2))
...
* Add loadMedia and getMedia methods ([#5652](https://github.com/gkatsev/videojs-release-test/issues/5652)) ([874cc21](https://github.com/gkatsev/videojs-release-test/commit/874cc21)), closes [#4342](https://github.com/gkatsev/videojs-release-test/issues/4342)
...
* **player:** add option to disable or override double-click handling. ([#5611](https://github.com/gkatsev/videojs-release-test/issues/5611)) ([e890923](https://github.com/gkatsev/videojs-release-test/commit/e890923)), closes [#5604](https://github.com/gkatsev/videojs-release-test/issues/5604)
...
* Add `videojs.getAllPlayers` to get an array of players. ([#4842](https://github.com/gkatsev/videojs-release-test/issues/4842)) ([6a00577](https://github.com/gkatsev/videojs-release-test/commit/6a00577))
...
* Queue playback events when the playback rate is zero and we are seeking ([#5024](https://github.com/gkatsev/videojs-release-test/issues/5024)) ([a2851fe](https://github.com/gkatsev/videojs-release-test/commit/a2851fe))
...
* time tooltips will not be added to a player on mobile devices ([#4185](https://github.com/gkatsev/videojs-release-test/issues/4185)) ([d79b8a7](https://github.com/gkatsev/videojs-release-test/commit/d79b8a7))
...
* **package:** update videojs-vtt.js to version 0.15.2 ([#6333](https://github.com/gkatsev/videojs-release-test/issues/6333)) ([7bbd0ca](https://github.com/gkatsev/videojs-release-test/commit/7bbd0ca)), closes [#6332](https://github.com/gkatsev/videojs-release-test/issues/6332)
...
* **lang:** update German translations ([#6058](https://github.com/gkatsev/videojs-release-test/issues/6058)) ([97b66a9](https://github.com/gkatsev/videojs-release-test/commit/97b66a9))
...
* blob urls being ignored as valid sources ([#5525](https://github.com/gkatsev/videojs-release-test/issues/5525)) ([8bf4206](https://github.com/gkatsev/videojs-release-test/commit/8bf4206)), closes [#5504](https://github.com/gkatsev/videojs-release-test/issues/5504)
...
* hide the progress control and show the subs-caps button when using Live UI at extra small size ([#5915](https://github.com/gkatsev/videojs-release-test/issues/5915)) ([55b3752](https://github.com/gkatsev/videojs-release-test/commit/55b3752))
...
* **player:** ensure that JAWS+IE announces the BPB and play button ([#5173](https://github.com/gkatsev/videojs-release-test/issues/5173)) ([2bc810d](https://github.com/gkatsev/videojs-release-test/commit/2bc810d)), closes [#4583](https://github.com/gkatsev/videojs-release-test/issues/4583)
...
* do not patch canplaytype on android chrome ([#4885](https://github.com/gkatsev/videojs-release-test/issues/4885)) ([f03ac5e](https://github.com/gkatsev/videojs-release-test/commit/f03ac5e))
...
* **lang:** Complete the Simplified Chinese translations (zn-CN.json) ([#4827](https://github.com/gkatsev/videojs-release-test/issues/4827)) ([98773dd](https://github.com/gkatsev/videojs-release-test/commit/98773dd))
...
* Remove unnecessary ARIA role on the Control Bar. ([#5154](https://github.com/gkatsev/videojs-release-test/issues/5154)) ([8a08957](https://github.com/gkatsev/videojs-release-test/commit/8a08957)), closes [#5134](https://github.com/gkatsev/videojs-release-test/issues/5134)
...
* Only update text track mode if changed ([#4298](https://github.com/gkatsev/videojs-release-test/issues/4298)) ([3087830](https://github.com/gkatsev/videojs-release-test/commit/3087830))
...
* warn on element not in DOM even when from another document ([#5831](https://github.com/gkatsev/videojs-release-test/issues/5831)) ([237b68b](https://github.com/gkatsev/videojs-release-test/commit/237b68b))
* **cues:** only copy cue props that don't exist ([#4145](https://github.com/gkatsev/videojs-release-test/issues/4145)) ([0f57341](https://github.com/gkatsev/videojs-release-test/commit/0f57341))
* **dom:** getBoundingClientRect check that el is defined ([#4139](https://github.com/gkatsev/videojs-release-test/issues/4139)) ([fb88ae2](https://github.com/gkatsev/videojs-release-test/commit/fb88ae2))
* **icon-placeholder:** align icons on ie8 properly ([#4174](https://github.com/gkatsev/videojs-release-test/issues/4174)) ([1770f00](https://github.com/gkatsev/videojs-release-test/commit/1770f00))
* **ie8:** various minor ie8 fixes ([#4175](https://github.com/gkatsev/videojs-release-test/issues/4175)) ([cb890a9](https://github.com/gkatsev/videojs-release-test/commit/cb890a9))
* **lang:** add missing strings in pt-BR ([#5122](https://github.com/gkatsev/videojs-release-test/issues/5122)) ([a00aa0d](https://github.com/gkatsev/videojs-release-test/commit/a00aa0d)), closes [#5121](https://github.com/gkatsev/videojs-release-test/issues/5121)
* **lang:** typos in ar.json ([#4528](https://github.com/gkatsev/videojs-release-test/issues/4528)) ([3e63bf3](https://github.com/gkatsev/videojs-release-test/commit/3e63bf3))
* **MenuButton:** Unify behavior of showing/hiding ([#4157](https://github.com/gkatsev/videojs-release-test/issues/4157)) ([c611f9f](https://github.com/gkatsev/videojs-release-test/commit/c611f9f))
* **package:** update [@videojs](https://github.com/videojs)/http-streaming to version 0.9.0 🚀 ([#5064](https://github.com/gkatsev/videojs-release-test/issues/5064)) ([11b4d5d](https://github.com/gkatsev/videojs-release-test/commit/11b4d5d))
* **package:** update [@videojs](https://github.com/videojs)/http-streaming to version 1.6.0 🚀 ([#5705](https://github.com/gkatsev/videojs-release-test/issues/5705)) ([3d093ed](https://github.com/gkatsev/videojs-release-test/commit/3d093ed))
* **package:** update videojs-font to version 2.1.0 ([#4812](https://github.com/gkatsev/videojs-release-test/issues/4812)) ([1117587](https://github.com/gkatsev/videojs-release-test/commit/1117587))
* **package:** update videojs-font to version 3.1.0 🚀 ([#5476](https://github.com/gkatsev/videojs-release-test/issues/5476)) ([29c8259](https://github.com/gkatsev/videojs-release-test/commit/29c8259))
* **package:** update videojs-vtt.js to version 0.14.1 🚀 ([#5085](https://github.com/gkatsev/videojs-release-test/issues/5085)) ([66d7545](https://github.com/gkatsev/videojs-release-test/commit/66d7545))
* **package:** update xhr to version 2.4.0 ([#4101](https://github.com/gkatsev/videojs-release-test/issues/4101)) ([5265624](https://github.com/gkatsev/videojs-release-test/commit/5265624))
* **play-toggle:** call event.stopPropagation in the click handler ([#5803](https://github.com/gkatsev/videojs-release-test/issues/5803)) ([2c7644f](https://github.com/gkatsev/videojs-release-test/commit/2c7644f)), closes [#5624](https://github.com/gkatsev/videojs-release-test/issues/5624)
* **playback rate menu:** playback rate menu items should be selectable ([#4149](https://github.com/gkatsev/videojs-release-test/issues/4149)) ([a9f8fcb](https://github.com/gkatsev/videojs-release-test/commit/a9f8fcb))
* **remaining-time-display:** make the '-' be visual and not readable by screen readers ([#5671](https://github.com/gkatsev/videojs-release-test/issues/5671)) ([9a8376e](https://github.com/gkatsev/videojs-release-test/commit/9a8376e)), closes [#5168](https://github.com/gkatsev/videojs-release-test/issues/5168)
* **resize-manager:** Prevent tabbing into RM and hide from Screen Readers ([#5754](https://github.com/gkatsev/videojs-release-test/issues/5754)) ([d94771f](https://github.com/gkatsev/videojs-release-test/commit/d94771f))
* **sass:** import path has cwd once again ([#4061](https://github.com/gkatsev/videojs-release-test/issues/4061)) ([caff93f](https://github.com/gkatsev/videojs-release-test/commit/caff93f))
* **seek-bar:** ensure aria-valuenow attribute in seek-bar is not NaN ([#5164](https://github.com/gkatsev/videojs-release-test/issues/5164)) ([ad1bb9d](https://github.com/gkatsev/videojs-release-test/commit/ad1bb9d)), closes [#4960](https://github.com/gkatsev/videojs-release-test/issues/4960)
* **seekbar:** don't disable if live tracker's seekable is infinity ([#5721](https://github.com/gkatsev/videojs-release-test/issues/5721)) ([f02fb1b](https://github.com/gkatsev/videojs-release-test/commit/f02fb1b))
* **sourceset:** set evt.src to empty string or src attr from load ([#5016](https://github.com/gkatsev/videojs-release-test/issues/5016)) ([46d8b37](https://github.com/gkatsev/videojs-release-test/commit/46d8b37))
* **subs-caps-button:** add hide threshold to subs-caps button ([#4171](https://github.com/gkatsev/videojs-release-test/issues/4171)) ([88ee6af](https://github.com/gkatsev/videojs-release-test/commit/88ee6af)), closes [#4157](https://github.com/gkatsev/videojs-release-test/issues/4157)
* **subs-caps-button:** add wrapper CSS builder to subs caps button ([#4156](https://github.com/gkatsev/videojs-release-test/issues/4156)) ([e5af0a5](https://github.com/gkatsev/videojs-release-test/commit/e5af0a5))
* **subs-caps-button:** captions items should hide icon from SR ([#4158](https://github.com/gkatsev/videojs-release-test/issues/4158)) ([2ee133f](https://github.com/gkatsev/videojs-release-test/commit/2ee133f))
* **text track display:** update on playerresize and orientationchange ([#5447](https://github.com/gkatsev/videojs-release-test/issues/5447)) ([e69842c](https://github.com/gkatsev/videojs-release-test/commit/e69842c))
* **text track settings:** focus subs-caps button if exists over CC button ([#4155](https://github.com/gkatsev/videojs-release-test/issues/4155)) ([db901c5](https://github.com/gkatsev/videojs-release-test/commit/db901c5))
* **TextTrackSetting:** Do not use default button type. ([#5512](https://github.com/gkatsev/videojs-release-test/issues/5512)) ([dfcfa45](https://github.com/gkatsev/videojs-release-test/commit/dfcfa45))
* **time-display:** restore hidden label text for screen readers. ([#5157](https://github.com/gkatsev/videojs-release-test/issues/5157)) ([0aa827f](https://github.com/gkatsev/videojs-release-test/commit/0aa827f)), closes [#5135](https://github.com/gkatsev/videojs-release-test/issues/5135)
* **tracks:** allow forcing native text tracks on or off ([#4172](https://github.com/gkatsev/videojs-release-test/issues/4172)) ([67634cf](https://github.com/gkatsev/videojs-release-test/commit/67634cf))
* **vjsstandard:** update to 8.0.2 and fixup linting ([#5413](https://github.com/gkatsev/videojs-release-test/issues/5413)) ([6bff3ce](https://github.com/gkatsev/videojs-release-test/commit/6bff3ce))
* accessibility bugs with the VolumeBar ([#4023](https://github.com/gkatsev/videojs-release-test/issues/4023)) ([da2a1e0](https://github.com/gkatsev/videojs-release-test/commit/da2a1e0)), closes [#4021](https://github.com/gkatsev/videojs-release-test/issues/4021) [#4022](https://github.com/gkatsev/videojs-release-test/issues/4022)
* add buildWrapperCSSClass methods to all menu buttons ([#4147](https://github.com/gkatsev/videojs-release-test/issues/4147)) ([61d427c](https://github.com/gkatsev/videojs-release-test/commit/61d427c)), closes [#4034](https://github.com/gkatsev/videojs-release-test/issues/4034)
* Add lang attribute to player el, so that css :lang() is correct ([#4046](https://github.com/gkatsev/videojs-release-test/issues/4046)) ([17143fd](https://github.com/gkatsev/videojs-release-test/commit/17143fd))
* addChild instance names should be toTitleCased ([#4116](https://github.com/gkatsev/videojs-release-test/issues/4116)) ([576ac19](https://github.com/gkatsev/videojs-release-test/commit/576ac19))
* allow changing volume in full height of volume control ([#3987](https://github.com/gkatsev/videojs-release-test/issues/3987)) ([f87ada1](https://github.com/gkatsev/videojs-release-test/commit/f87ada1))
* allow rounded value for fluid player ratio test ([#3739](https://github.com/gkatsev/videojs-release-test/issues/3739)) ([2e720af](https://github.com/gkatsev/videojs-release-test/commit/2e720af))
* aria-live="assertive" only for descriptions ([685404d](https://github.com/gkatsev/videojs-release-test/commit/685404d)), closes [#3554](https://github.com/gkatsev/videojs-release-test/issues/3554)
* copy basic plugin properties onto the wrapper ([#4100](https://github.com/gkatsev/videojs-release-test/issues/4100)) ([127cd78](https://github.com/gkatsev/videojs-release-test/commit/127cd78))
* cues at startTime 0 do not fire ([#4152](https://github.com/gkatsev/videojs-release-test/issues/4152)) ([a2b1a33](https://github.com/gkatsev/videojs-release-test/commit/a2b1a33))
* currentDimension can return 0 for fluid player on IE ([#3738](https://github.com/gkatsev/videojs-release-test/issues/3738)) ([74cddca](https://github.com/gkatsev/videojs-release-test/commit/74cddca))
* Disable all time tooltips in IE8, as they are broken ([#4029](https://github.com/gkatsev/videojs-release-test/issues/4029)) ([60bcc99](https://github.com/gkatsev/videojs-release-test/commit/60bcc99))
* disable HLS hack on Firefox for Android ([#3586](https://github.com/gkatsev/videojs-release-test/issues/3586)) ([dd2aff0](https://github.com/gkatsev/videojs-release-test/commit/dd2aff0))
* disable title attribute on menu items ([#4019](https://github.com/gkatsev/videojs-release-test/issues/4019)) ([04f23c1](https://github.com/gkatsev/videojs-release-test/commit/04f23c1)), closes [#3699](https://github.com/gkatsev/videojs-release-test/issues/3699)
* Do not create element for MediaLoader ([#4097](https://github.com/gkatsev/videojs-release-test/issues/4097)) ([1cb0a97](https://github.com/gkatsev/videojs-release-test/commit/1cb0a97)), closes [#4070](https://github.com/gkatsev/videojs-release-test/issues/4070)
* don't emit tap events on tech when using native controls ([#3873](https://github.com/gkatsev/videojs-release-test/issues/3873)) ([42507f8](https://github.com/gkatsev/videojs-release-test/commit/42507f8))
* early play should wait for player ready, even if source is available ([#4134](https://github.com/gkatsev/videojs-release-test/issues/4134)) ([3bbf019](https://github.com/gkatsev/videojs-release-test/commit/3bbf019)), closes [#4057](https://github.com/gkatsev/videojs-release-test/issues/4057)
* EventTarget is also evented ([#3990](https://github.com/gkatsev/videojs-release-test/issues/3990)) ([e34335b](https://github.com/gkatsev/videojs-release-test/commit/e34335b))
* extra warn logs on already initialized player references ([#3888](https://github.com/gkatsev/videojs-release-test/issues/3888)) ([b7c384e](https://github.com/gkatsev/videojs-release-test/commit/b7c384e))
* fire sourceset on initial source append ([#5038](https://github.com/gkatsev/videojs-release-test/issues/5038)) ([9eb5de7](https://github.com/gkatsev/videojs-release-test/commit/9eb5de7))
* fix the structure of elements in menus to comply with ARIA requirements ([#4034](https://github.com/gkatsev/videojs-release-test/issues/4034)) ([1b1ba04](https://github.com/gkatsev/videojs-release-test/commit/1b1ba04))
* focus play toggle from Big Play Btn on play ([#4018](https://github.com/gkatsev/videojs-release-test/issues/4018)) ([4f79e1e](https://github.com/gkatsev/videojs-release-test/commit/4f79e1e)), closes [#2729](https://github.com/gkatsev/videojs-release-test/issues/2729)
* give techs a name ([#3934](https://github.com/gkatsev/videojs-release-test/issues/3934)) ([94fd5c1](https://github.com/gkatsev/videojs-release-test/commit/94fd5c1)), closes [#1786](https://github.com/gkatsev/videojs-release-test/issues/1786)
* hide font-icons from assitive technology ([#4006](https://github.com/gkatsev/videojs-release-test/issues/4006)) ([24d2e7b](https://github.com/gkatsev/videojs-release-test/commit/24d2e7b)), closes [#3982](https://github.com/gkatsev/videojs-release-test/issues/3982)
* improve French translation ([#4062](https://github.com/gkatsev/videojs-release-test/issues/4062)) ([dc4c1eb](https://github.com/gkatsev/videojs-release-test/commit/dc4c1eb))
* let the tech preload auto on its own ([#4861](https://github.com/gkatsev/videojs-release-test/issues/4861)) ([fdcae1b](https://github.com/gkatsev/videojs-release-test/commit/fdcae1b)), closes [#4660](https://github.com/gkatsev/videojs-release-test/issues/4660)
* localize aria-labels ([#4027](https://github.com/gkatsev/videojs-release-test/issues/4027)) ([0ac1269](https://github.com/gkatsev/videojs-release-test/commit/0ac1269)), closes [#2728](https://github.com/gkatsev/videojs-release-test/issues/2728)
* logging failing on browsers that don't always have console ([#3686](https://github.com/gkatsev/videojs-release-test/issues/3686)) ([e932061](https://github.com/gkatsev/videojs-release-test/commit/e932061))
* Make `Player#techCall_()` synchronous again ([#3988](https://github.com/gkatsev/videojs-release-test/issues/3988)) ([3585af0](https://github.com/gkatsev/videojs-release-test/commit/3585af0))
* make mergeOptions behave the same across browsers ([#4088](https://github.com/gkatsev/videojs-release-test/issues/4088)) ([0da9324](https://github.com/gkatsev/videojs-release-test/commit/0da9324))
* make sure all attributes are updated before applying to tag ([#5416](https://github.com/gkatsev/videojs-release-test/issues/5416)) ([b25f024](https://github.com/gkatsev/videojs-release-test/commit/b25f024)), closes [#5309](https://github.com/gkatsev/videojs-release-test/issues/5309)
* make sure that document.createElement exists before using ([#3706](https://github.com/gkatsev/videojs-release-test/issues/3706)) ([49e29ba](https://github.com/gkatsev/videojs-release-test/commit/49e29ba)), closes [#3665](https://github.com/gkatsev/videojs-release-test/issues/3665)
* move html5 source handler incantation to bottom ([#3695](https://github.com/gkatsev/videojs-release-test/issues/3695)) ([7b9574b](https://github.com/gkatsev/videojs-release-test/commit/7b9574b))
* Muting with `MuteToggle` sets ARIA value of `VolumeBar` to 0 ([#4099](https://github.com/gkatsev/videojs-release-test/issues/4099)) ([181a19f](https://github.com/gkatsev/videojs-release-test/commit/181a19f)), closes [#4064](https://github.com/gkatsev/videojs-release-test/issues/4064)
* Patch a memory leak caused by un-removed track listener(s). ([#3976](https://github.com/gkatsev/videojs-release-test/issues/3976)) ([4979ea7](https://github.com/gkatsev/videojs-release-test/commit/4979ea7))
* Pause player before seeking in seek bar mousedown ([#3921](https://github.com/gkatsev/videojs-release-test/issues/3921)) ([2ceed0a](https://github.com/gkatsev/videojs-release-test/commit/2ceed0a)), closes [#3839](https://github.com/gkatsev/videojs-release-test/issues/3839) [#3886](https://github.com/gkatsev/videojs-release-test/issues/3886)
* playback rate default text ([#4558](https://github.com/gkatsev/videojs-release-test/issues/4558)) ([a6b8425](https://github.com/gkatsev/videojs-release-test/commit/a6b8425))
* player el ingest when parent doesn't have `hasAttribute` method ([#3929](https://github.com/gkatsev/videojs-release-test/issues/3929)) ([bbe8253](https://github.com/gkatsev/videojs-release-test/commit/bbe8253))
* Progress holder gaps cause tooltips misalignment and time tooltip outlines ([#4031](https://github.com/gkatsev/videojs-release-test/issues/4031)) ([be27f2a](https://github.com/gkatsev/videojs-release-test/commit/be27f2a)), closes [#3645](https://github.com/gkatsev/videojs-release-test/issues/3645) [#3645](https://github.com/gkatsev/videojs-release-test/issues/3645)
* proxy ios webkit events into fullscreenchange ([#3644](https://github.com/gkatsev/videojs-release-test/issues/3644)) ([e479f8c](https://github.com/gkatsev/videojs-release-test/commit/e479f8c))
* remaining time display width on IE8 and IE9 ([#3983](https://github.com/gkatsev/videojs-release-test/issues/3983)) ([866a3f3](https://github.com/gkatsev/videojs-release-test/commit/866a3f3))
* remote text track deprecation warnings ([#3864](https://github.com/gkatsev/videojs-release-test/issues/3864)) ([a7ffa34](https://github.com/gkatsev/videojs-release-test/commit/a7ffa34))
* remove 'use strict' from rollup because vttjs isn't strict ([#4551](https://github.com/gkatsev/videojs-release-test/issues/4551)) ([db55bbd](https://github.com/gkatsev/videojs-release-test/commit/db55bbd))
* remove redundant Html5#play() ([405b29b](https://github.com/gkatsev/videojs-release-test/commit/405b29b))
* remove vjs-seeking on src change ([#3846](https://github.com/gkatsev/videojs-release-test/issues/3846)) ([83cbeec](https://github.com/gkatsev/videojs-release-test/commit/83cbeec)), closes [#3765](https://github.com/gkatsev/videojs-release-test/issues/3765)
* Set MuteButton controlText correctly ([#4056](https://github.com/gkatsev/videojs-release-test/issues/4056)) ([3c1108c](https://github.com/gkatsev/videojs-release-test/commit/3c1108c))
* showing custom poster with controls disabled ([#3933](https://github.com/gkatsev/videojs-release-test/issues/3933)) ([305e5ea](https://github.com/gkatsev/videojs-release-test/commit/305e5ea)), closes [#1625](https://github.com/gkatsev/videojs-release-test/issues/1625)
* Solve a typo in translation files ([#4063](https://github.com/gkatsev/videojs-release-test/issues/4063)) ([5540868](https://github.com/gkatsev/videojs-release-test/commit/5540868))
* support empty src in `Player#src` ([#4030](https://github.com/gkatsev/videojs-release-test/issues/4030)) ([6541467](https://github.com/gkatsev/videojs-release-test/commit/6541467))
* Support require()-ing video.js ([#3889](https://github.com/gkatsev/videojs-release-test/issues/3889)) ([ac0b03f](https://github.com/gkatsev/videojs-release-test/commit/ac0b03f)), closes [#3869](https://github.com/gkatsev/videojs-release-test/issues/3869)
* synchronously shim vtt.js when possible ([#4083](https://github.com/gkatsev/videojs-release-test/issues/4083)) ([e1b4804](https://github.com/gkatsev/videojs-release-test/commit/e1b4804))
* trap tab focus in modal when hitting s-tab ([#4075](https://github.com/gkatsev/videojs-release-test/issues/4075)) ([1f7a842](https://github.com/gkatsev/videojs-release-test/commit/1f7a842)), closes [#4049](https://github.com/gkatsev/videojs-release-test/issues/4049)
* trigger timeupdate during seek ([#4754](https://github.com/gkatsev/videojs-release-test/issues/4754)) ([1fcd5ae](https://github.com/gkatsev/videojs-release-test/commit/1fcd5ae))
* updating time tooltips when player not in DOM ([#3991](https://github.com/gkatsev/videojs-release-test/issues/3991)) ([22aade1](https://github.com/gkatsev/videojs-release-test/commit/22aade1))
* use consistent id for tech, no matter how it is loaded ([#5415](https://github.com/gkatsev/videojs-release-test/issues/5415)) ([6d6bfd1](https://github.com/gkatsev/videojs-release-test/commit/6d6bfd1)), closes [#5411](https://github.com/gkatsev/videojs-release-test/issues/5411)
* wait till play event to listen for user activity ([#5093](https://github.com/gkatsev/videojs-release-test/issues/5093)) ([d0b03a3](https://github.com/gkatsev/videojs-release-test/commit/d0b03a3)), closes [#5076](https://github.com/gkatsev/videojs-release-test/issues/5076)
* **controls:** fix load progress bar never highlighting first buffered time range ([ca02298](https://github.com/gkatsev/videojs-release-test/commit/ca02298))
* **css:** remove commented out css ([5fdcd46](https://github.com/gkatsev/videojs-release-test/commit/5fdcd46)), closes [#3587](https://github.com/gkatsev/videojs-release-test/issues/3587)
* **html5:** (un)patchCanPlayType could set native canPlayType to null ([#3863](https://github.com/gkatsev/videojs-release-test/issues/3863)) ([559297a](https://github.com/gkatsev/videojs-release-test/commit/559297a))
* **html5:** disable manual timeupdate events on html5 tech ([#3656](https://github.com/gkatsev/videojs-release-test/issues/3656)) ([920c54a](https://github.com/gkatsev/videojs-release-test/commit/920c54a))
* **html5:** exit early on emulated tracks in html5 ([#3772](https://github.com/gkatsev/videojs-release-test/issues/3772)) ([252bcee](https://github.com/gkatsev/videojs-release-test/commit/252bcee))
* **HtmlTrackElementList:** allow to reference by index via bracket notation ([#3776](https://github.com/gkatsev/videojs-release-test/issues/3776)) ([430be94](https://github.com/gkatsev/videojs-release-test/commit/430be94))
* **package:** update global to version 4.3.2 ([#4291](https://github.com/gkatsev/videojs-release-test/issues/4291)) ([b5c60f3](https://github.com/gkatsev/videojs-release-test/commit/b5c60f3))
* **playback rate menu:** cycling rates via click ([#4486](https://github.com/gkatsev/videojs-release-test/issues/4486)) ([4f43616](https://github.com/gkatsev/videojs-release-test/commit/4f43616))
* **Player#play:** Wait for loadstart in play() when changing sources instead of just ready. ([#4743](https://github.com/gkatsev/videojs-release-test/issues/4743)) ([26b0d2c](https://github.com/gkatsev/videojs-release-test/commit/26b0d2c)), closes [#4665](https://github.com/gkatsev/videojs-release-test/issues/4665)
* **sass:** import path no longer has cwd ([#4001](https://github.com/gkatsev/videojs-release-test/issues/4001)) ([19b429b](https://github.com/gkatsev/videojs-release-test/commit/19b429b)), closes [#3998](https://github.com/gkatsev/videojs-release-test/issues/3998)
* **seeking:** don't always pause in mouse down ([#3886](https://github.com/gkatsev/videojs-release-test/issues/3886)) ([e92db4f](https://github.com/gkatsev/videojs-release-test/commit/e92db4f)), closes [#3839](https://github.com/gkatsev/videojs-release-test/issues/3839)
* **throttle:** Fix error in Fn.throttle that broke MouseTimeDisplay ([#3833](https://github.com/gkatsev/videojs-release-test/issues/3833)) ([014c6b8](https://github.com/gkatsev/videojs-release-test/commit/014c6b8))
* **time-display:** Use formatTime for a consistent default instead of hardcoded string ([#5055](https://github.com/gkatsev/videojs-release-test/issues/5055)) ([228484b](https://github.com/gkatsev/videojs-release-test/commit/228484b))
* **vttjs:** wait till tech el in DOM before loading vttjs ([#4177](https://github.com/gkatsev/videojs-release-test/issues/4177)) ([ddde644](https://github.com/gkatsev/videojs-release-test/commit/ddde644))
* remove unnecessary comments from video.min.js ([#3709](https://github.com/gkatsev/videojs-release-test/issues/3709)) ([fe760a4](https://github.com/gkatsev/videojs-release-test/commit/fe760a4)), closes [#3707](https://github.com/gkatsev/videojs-release-test/issues/3707)
* Restore timeupdate/loadedmetadata listeners for duration display ([#3682](https://github.com/gkatsev/videojs-release-test/issues/3682)) ([44ec0e4](https://github.com/gkatsev/videojs-release-test/commit/44ec0e4)), closes [#3349](https://github.com/gkatsev/videojs-release-test/issues/3349)
* Suppress Infinity duration on Android Chrome before playback ([#3476](https://github.com/gkatsev/videojs-release-test/issues/3476)) ([ed59531](https://github.com/gkatsev/videojs-release-test/commit/ed59531)), closes [#3079](https://github.com/gkatsev/videojs-release-test/issues/3079)

### Chores

* add a sandbox for HLS ([#5897](https://github.com/gkatsev/videojs-release-test/issues/5897)) ([8e43cff](https://github.com/gkatsev/videojs-release-test/commit/8e43cff))
* add a sandbox page for testing autoplay values. ([#5933](https://github.com/gkatsev/videojs-release-test/issues/5933)) ([1eb47f0](https://github.com/gkatsev/videojs-release-test/commit/1eb47f0))
* add Affects: a11y and switch to outdated label ([#6015](https://github.com/gkatsev/videojs-release-test/issues/6015)) ([1cd9be7](https://github.com/gkatsev/videojs-release-test/commit/1cd9be7))
* add semantic-release github action ([6939a3b](https://github.com/gkatsev/videojs-release-test/commit/6939a3b))
* change rollup config so that npm run watch works ([#5966](https://github.com/gkatsev/videojs-release-test/issues/5966)) ([45d1ca9](https://github.com/gkatsev/videojs-release-test/commit/45d1ca9))
* don't log karma config ([#5955](https://github.com/gkatsev/videojs-release-test/issues/5955)) ([4d626b0](https://github.com/gkatsev/videojs-release-test/commit/4d626b0))
* fix lang watch loop caused by zh-* copy ([#6147](https://github.com/gkatsev/videojs-release-test/issues/6147)) ([4b325ea](https://github.com/gkatsev/videojs-release-test/commit/4b325ea))
* fix xvfb in travis config, patch safari karma launchers ([#5755](https://github.com/gkatsev/videojs-release-test/issues/5755)) ([144907f](https://github.com/gkatsev/videojs-release-test/commit/144907f))
* fixup merge issue with [#6001](https://github.com/gkatsev/videojs-release-test/issues/6001) ([#6053](https://github.com/gkatsev/videojs-release-test/issues/6053)) ([c2bea31](https://github.com/gkatsev/videojs-release-test/commit/c2bea31))
* ignore sandbox during linting ([#6208](https://github.com/gkatsev/videojs-release-test/issues/6208)) ([de2daea](https://github.com/gkatsev/videojs-release-test/commit/de2daea))
* include changelog from 7.6.x branch ([a615236](https://github.com/gkatsev/videojs-release-test/commit/a615236))
* install semantic-release and deps ([7f63086](https://github.com/gkatsev/videojs-release-test/commit/7f63086))
* package json cleanup ([#5649](https://github.com/gkatsev/videojs-release-test/issues/5649)) ([85ad44e](https://github.com/gkatsev/videojs-release-test/commit/85ad44e))
* pin to firefox 64 ([#5793](https://github.com/gkatsev/videojs-release-test/issues/5793)) ([b64ecde](https://github.com/gkatsev/videojs-release-test/commit/b64ecde))
* rename test package ([89b9458](https://github.com/gkatsev/videojs-release-test/commit/89b9458))
* switch from deprecated `jsnext`, `main` options to mainFields ([#6075](https://github.com/gkatsev/videojs-release-test/issues/6075)) ([2e69448](https://github.com/gkatsev/videojs-release-test/commit/2e69448))
* switch to dart-sass ([#6055](https://github.com/gkatsev/videojs-release-test/issues/6055)) ([3e10571](https://github.com/gkatsev/videojs-release-test/commit/3e10571)), closes [#5841](https://github.com/gkatsev/videojs-release-test/issues/5841) [#5841](https://github.com/gkatsev/videojs-release-test/issues/5841) [#5826](https://github.com/gkatsev/videojs-release-test/issues/5826)
* update package-lock.json ([221497f](https://github.com/gkatsev/videojs-release-test/commit/221497f))
* **dom.js:** Fix misspellings ([#5008](https://github.com/gkatsev/videojs-release-test/issues/5008)) ([e833d3e](https://github.com/gkatsev/videojs-release-test/commit/e833d3e))
* **netlify:** make docs build properly ([#5636](https://github.com/gkatsev/videojs-release-test/issues/5636)) ([a8828cd](https://github.com/gkatsev/videojs-release-test/commit/a8828cd))
* **package:** update [@videojs](https://github.com/videojs)/http-streaming to version 1.9.0 🚀 ([#5784](https://github.com/gkatsev/videojs-release-test/issues/5784)) ([3400dc6](https://github.com/gkatsev/videojs-release-test/commit/3400dc6))
* **package:** update autoprefixer to version 9.4.2 ([#5647](https://github.com/gkatsev/videojs-release-test/issues/5647)) ([19f3465](https://github.com/gkatsev/videojs-release-test/commit/19f3465))
* **package:** update babel to version 7.2.2 ([#5697](https://github.com/gkatsev/videojs-release-test/issues/5697)) ([30d0b98](https://github.com/gkatsev/videojs-release-test/commit/30d0b98)), closes [#5689](https://github.com/gkatsev/videojs-release-test/issues/5689)
* **package:** update filesize to version 4.0.0 🚀 ([#5746](https://github.com/gkatsev/videojs-release-test/issues/5746)) ([6910d39](https://github.com/gkatsev/videojs-release-test/commit/6910d39))
* **package:** update http-streaming to 1.10.6 ([#6205](https://github.com/gkatsev/videojs-release-test/issues/6205)) ([f47939c](https://github.com/gkatsev/videojs-release-test/commit/f47939c)), closes [videojs/http-streaming#312](https://github.com/videojs/http-streaming/issues/312)
* 6.x build updates ([#4228](https://github.com/gkatsev/videojs-release-test/issues/4228)) ([6d876ee](https://github.com/gkatsev/videojs-release-test/commit/6d876ee))
* make sure first-timers bot uses our template ([#5001](https://github.com/gkatsev/videojs-release-test/issues/5001)) ([43b5a6d](https://github.com/gkatsev/videojs-release-test/commit/43b5a6d))
* update videojs-generate-karma-config to ~5.2.1 and remove patches ([#6104](https://github.com/gkatsev/videojs-release-test/issues/6104)) ([b9fbd0b](https://github.com/gkatsev/videojs-release-test/commit/b9fbd0b))
* **build:** remove unused var in build/version.js ([#4458](https://github.com/gkatsev/videojs-release-test/issues/4458)) ([6986dbb](https://github.com/gkatsev/videojs-release-test/commit/6986dbb))
* **docs site:** use git commit message for netlify build ([#4900](https://github.com/gkatsev/videojs-release-test/issues/4900)) ([ddfaf14](https://github.com/gkatsev/videojs-release-test/commit/ddfaf14))
* **gh-release:** add prerelease flag and find right zip  ([#4488](https://github.com/gkatsev/videojs-release-test/issues/4488)) ([b1ac2e0](https://github.com/gkatsev/videojs-release-test/commit/b1ac2e0))
* **gh-release:** no console log on success ([#4657](https://github.com/gkatsev/videojs-release-test/issues/4657)) ([e8511a5](https://github.com/gkatsev/videojs-release-test/commit/e8511a5))
* **greenkeeper:** ignore webpack and uglify ([#4518](https://github.com/gkatsev/videojs-release-test/issues/4518)) ([fe95a77](https://github.com/gkatsev/videojs-release-test/commit/fe95a77))
* **lang:** Add translation for "caption settings" in zh-CN.json ([#4815](https://github.com/gkatsev/videojs-release-test/issues/4815)) ([15cd32e](https://github.com/gkatsev/videojs-release-test/commit/15cd32e))
* **lang:** Add translation for "caption settings" in zh-TW.json ([#4816](https://github.com/gkatsev/videojs-release-test/issues/4816)) ([029955a](https://github.com/gkatsev/videojs-release-test/commit/029955a))
* **lang:** Update Dutch ([#4588](https://github.com/gkatsev/videojs-release-test/issues/4588)) ([5ca0992](https://github.com/gkatsev/videojs-release-test/commit/5ca0992))
* **lang:** update Persian translations ([#4741](https://github.com/gkatsev/videojs-release-test/issues/4741)) ([95d7832](https://github.com/gkatsev/videojs-release-test/commit/95d7832))
* **lang:** Update Polish ([#4686](https://github.com/gkatsev/videojs-release-test/issues/4686)) ([ee2a49c](https://github.com/gkatsev/videojs-release-test/commit/ee2a49c))
* **package:** update conventional-changelog-cli to version 2.0.11 ([#5552](https://github.com/gkatsev/videojs-release-test/issues/5552)) ([f236176](https://github.com/gkatsev/videojs-release-test/commit/f236176))
* **package:** update dependencies ([#4908](https://github.com/gkatsev/videojs-release-test/issues/4908)) ([dcab42e](https://github.com/gkatsev/videojs-release-test/commit/dcab42e))
* **package:** update grunt-accessibility to version 6.0.0 🚀 ([#4968](https://github.com/gkatsev/videojs-release-test/issues/4968)) ([270a231](https://github.com/gkatsev/videojs-release-test/commit/270a231))
* **package:** update grunt-cli to version 1.3.2 ([#5550](https://github.com/gkatsev/videojs-release-test/issues/5550)) ([2d27b6a](https://github.com/gkatsev/videojs-release-test/commit/2d27b6a))
* **package:** update husky to version 1.1.3 ([#5551](https://github.com/gkatsev/videojs-release-test/issues/5551)) ([937e2bf](https://github.com/gkatsev/videojs-release-test/commit/937e2bf))
* **package:** update karma to version 4.0.0 🚀 ([#5764](https://github.com/gkatsev/videojs-release-test/issues/5764)) ([9786d8a](https://github.com/gkatsev/videojs-release-test/commit/9786d8a))
* **package:** update patch-package to version 6.0.2 ([#5792](https://github.com/gkatsev/videojs-release-test/issues/5792)) ([de9fb58](https://github.com/gkatsev/videojs-release-test/commit/de9fb58)), closes [#5769](https://github.com/gkatsev/videojs-release-test/issues/5769)
* **package:** update qunit to version 2.9.1 🚀 ([#5735](https://github.com/gkatsev/videojs-release-test/issues/5735)) ([67a437b](https://github.com/gkatsev/videojs-release-test/commit/67a437b))
* **package:** update rollup to version 0.68.0 🚀 ([#5690](https://github.com/gkatsev/videojs-release-test/issues/5690)) ([f0ba1f5](https://github.com/gkatsev/videojs-release-test/commit/f0ba1f5))
* **package:** update rollup to version 1.0.1 ([#5727](https://github.com/gkatsev/videojs-release-test/issues/5727)) ([3e3387f](https://github.com/gkatsev/videojs-release-test/commit/3e3387f)), closes [#5715](https://github.com/gkatsev/videojs-release-test/issues/5715)
* **package:** update rollup to version 1.15.1 ([#6042](https://github.com/gkatsev/videojs-release-test/issues/6042)) ([74fde94](https://github.com/gkatsev/videojs-release-test/commit/74fde94)), closes [#6041](https://github.com/gkatsev/videojs-release-test/issues/6041)
* add first-timers-issue-template.md ([#4958](https://github.com/gkatsev/videojs-release-test/issues/4958)) ([f5c7373](https://github.com/gkatsev/videojs-release-test/commit/f5c7373))
* fix lint on pre-commit with lint-staged, use npm-merge-driver ([#5591](https://github.com/gkatsev/videojs-release-test/issues/5591)) ([be9e9a9](https://github.com/gkatsev/videojs-release-test/commit/be9e9a9))
* fix travis build ([#5627](https://github.com/gkatsev/videojs-release-test/issues/5627)) ([6c1056b](https://github.com/gkatsev/videojs-release-test/commit/6c1056b)), closes [#5626](https://github.com/gkatsev/videojs-release-test/issues/5626) [#5616](https://github.com/gkatsev/videojs-release-test/issues/5616)
* generate a test example on netlify for PRs ([#4912](https://github.com/gkatsev/videojs-release-test/issues/4912)) ([8b54737](https://github.com/gkatsev/videojs-release-test/commit/8b54737))
* Move a11y, lang, browserify, and webpack out of grunt ([#5589](https://github.com/gkatsev/videojs-release-test/issues/5589)) ([db6e376](https://github.com/gkatsev/videojs-release-test/commit/db6e376))
* re-enable Greenkeeper 🌴 and make it update package-lock.json ([#4967](https://github.com/gkatsev/videojs-release-test/issues/4967)) ([aa5f3bf](https://github.com/gkatsev/videojs-release-test/commit/aa5f3bf))
* switch from cross-var to cross-env ([#5600](https://github.com/gkatsev/videojs-release-test/issues/5600)) ([ab740bc](https://github.com/gkatsev/videojs-release-test/commit/ab740bc))
* update dependencies ([#6036](https://github.com/gkatsev/videojs-release-test/issues/6036)) ([882432e](https://github.com/gkatsev/videojs-release-test/commit/882432e)), closes [#6033](https://github.com/gkatsev/videojs-release-test/issues/6033)
* **lang:** update translations needed doc ([#4858](https://github.com/gkatsev/videojs-release-test/issues/4858)) ([df0d705](https://github.com/gkatsev/videojs-release-test/commit/df0d705))
* **lang:** Update Vietnamese ([#4625](https://github.com/gkatsev/videojs-release-test/issues/4625)) ([ac58dbf](https://github.com/gkatsev/videojs-release-test/commit/ac58dbf))
* **netlify:** add some debug info in the netlify command ([#4862](https://github.com/gkatsev/videojs-release-test/issues/4862)) ([8f450ea](https://github.com/gkatsev/videojs-release-test/commit/8f450ea))
* **package:** update grunt-babel to version 7.0.0 ([#4553](https://github.com/gkatsev/videojs-release-test/issues/4553)) ([f6f9998](https://github.com/gkatsev/videojs-release-test/commit/f6f9998))
* **package:** update grunt-browserify to version 5.1.0 ([#4565](https://github.com/gkatsev/videojs-release-test/issues/4565)) ([8c21f0a](https://github.com/gkatsev/videojs-release-test/commit/8c21f0a))
* **package:** update husky to version 0.14.1 ([#4444](https://github.com/gkatsev/videojs-release-test/issues/4444)) ([66a0d23](https://github.com/gkatsev/videojs-release-test/commit/66a0d23)), closes [#4436](https://github.com/gkatsev/videojs-release-test/issues/4436)
* **package:** update karma to version 2.0.0 ([#4834](https://github.com/gkatsev/videojs-release-test/issues/4834)) ([22fcd03](https://github.com/gkatsev/videojs-release-test/commit/22fcd03))
* **package:** update npm-run-all to 4.1.5 to remove event-stream ([#5614](https://github.com/gkatsev/videojs-release-test/issues/5614)) ([3e52c4f](https://github.com/gkatsev/videojs-release-test/commit/3e52c4f))
* **package:** update remark-cli to version 5.0.0 ([#4894](https://github.com/gkatsev/videojs-release-test/issues/4894)) ([aee4e6b](https://github.com/gkatsev/videojs-release-test/commit/aee4e6b))
* **package:** update remark-parse to version 5.0.0 ([#4892](https://github.com/gkatsev/videojs-release-test/issues/4892)) ([2c59476](https://github.com/gkatsev/videojs-release-test/commit/2c59476))
* **package:** update remark-stringify to version 5.0.0 ([#4893](https://github.com/gkatsev/videojs-release-test/issues/4893)) ([5b76bb1](https://github.com/gkatsev/videojs-release-test/commit/5b76bb1))
* **package:** update remark-stringify to version 6.0.1 ([#5539](https://github.com/gkatsev/videojs-release-test/issues/5539)) ([d46828a](https://github.com/gkatsev/videojs-release-test/commit/d46828a))
* **package:** update remark-validate-links to version 8.0.0 🚀 ([#5740](https://github.com/gkatsev/videojs-release-test/issues/5740)) ([72988d3](https://github.com/gkatsev/videojs-release-test/commit/72988d3))
* **package:** update rollup to version 0.67.1 ([#5580](https://github.com/gkatsev/videojs-release-test/issues/5580)) ([209d9f9](https://github.com/gkatsev/videojs-release-test/commit/209d9f9))
* **package:** update rollup-plugin-node-resolve to version 4.0.0 🚀 ([#5666](https://github.com/gkatsev/videojs-release-test/issues/5666)) ([d07b6c2](https://github.com/gkatsev/videojs-release-test/commit/d07b6c2))
* **package:** update rollup-plugin-progress to version 1.0.0 🚀 ([#5729](https://github.com/gkatsev/videojs-release-test/issues/5729)) ([513168f](https://github.com/gkatsev/videojs-release-test/commit/513168f))
* **package:** update shelljs to version 0.8.1 ([#4899](https://github.com/gkatsev/videojs-release-test/issues/4899)) ([87cbd23](https://github.com/gkatsev/videojs-release-test/commit/87cbd23)), closes [#4875](https://github.com/gkatsev/videojs-release-test/issues/4875)
* **package:** update videojs-generate-karma-config to version 5.0.0 🚀 ([#5595](https://github.com/gkatsev/videojs-release-test/issues/5595)) ([2162239](https://github.com/gkatsev/videojs-release-test/commit/2162239))
* **package:** update videojs-generate-karma-config to version 5.1.0 🚀 ([#5843](https://github.com/gkatsev/videojs-release-test/issues/5843)) ([d7379f0](https://github.com/gkatsev/videojs-release-test/commit/d7379f0))
* **package:** update videojs-generate-karma-config to version 5.2.0 🚀 ([#5935](https://github.com/gkatsev/videojs-release-test/issues/5935)) ([7e8c2ee](https://github.com/gkatsev/videojs-release-test/commit/7e8c2ee))
* **player:** fix linting for a comment ([#5588](https://github.com/gkatsev/videojs-release-test/issues/5588)) ([b5e6bdc](https://github.com/gkatsev/videojs-release-test/commit/b5e6bdc))
* **test:** upgrade to latest sinon ([#5954](https://github.com/gkatsev/videojs-release-test/issues/5954)) ([c59ba5f](https://github.com/gkatsev/videojs-release-test/commit/c59ba5f)), closes [#5953](https://github.com/gkatsev/videojs-release-test/issues/5953)
* **text-track:** fix it's/its typo ([#5868](https://github.com/gkatsev/videojs-release-test/issues/5868)) ([92c66ad](https://github.com/gkatsev/videojs-release-test/commit/92c66ad))
* add automatic github release ([#4466](https://github.com/gkatsev/videojs-release-test/issues/4466)) ([3a600d0](https://github.com/gkatsev/videojs-release-test/commit/3a600d0))
* add comment about avoiding helvetica font ([#4679](https://github.com/gkatsev/videojs-release-test/issues/4679)) ([cb638d0](https://github.com/gkatsev/videojs-release-test/commit/cb638d0)), closes [#376](https://github.com/gkatsev/videojs-release-test/issues/376)
* add GA note to primary readme ([#4481](https://github.com/gkatsev/videojs-release-test/issues/4481)) ([e2af322](https://github.com/gkatsev/videojs-release-test/commit/e2af322))
* Add package-lock.json file. ([#4641](https://github.com/gkatsev/videojs-release-test/issues/4641)) ([ec5b603](https://github.com/gkatsev/videojs-release-test/commit/ec5b603))
* alias rollup-dev to watch for development ([#4615](https://github.com/gkatsev/videojs-release-test/issues/4615)) ([edde614](https://github.com/gkatsev/videojs-release-test/commit/edde614))
* css is not built initially on grunt dev ([#4778](https://github.com/gkatsev/videojs-release-test/issues/4778)) ([c5ae98b](https://github.com/gkatsev/videojs-release-test/commit/c5ae98b))
* fix gh-release minimist call ([#4489](https://github.com/gkatsev/videojs-release-test/issues/4489)) ([07594bc](https://github.com/gkatsev/videojs-release-test/commit/07594bc))
* improve dev and beginner experience ([#4555](https://github.com/gkatsev/videojs-release-test/issues/4555)) ([19ebc0d](https://github.com/gkatsev/videojs-release-test/commit/19ebc0d))
* move copy, zip, and clean tasks to npm scripts ([#5544](https://github.com/gkatsev/videojs-release-test/issues/5544)) ([2d682a4](https://github.com/gkatsev/videojs-release-test/commit/2d682a4))
* remove grunt move to npm scripts ([#5592](https://github.com/gkatsev/videojs-release-test/issues/5592)) ([d72786f](https://github.com/gkatsev/videojs-release-test/commit/d72786f))
* remove unused deps ([#4814](https://github.com/gkatsev/videojs-release-test/issues/4814)) ([dede592](https://github.com/gkatsev/videojs-release-test/commit/dede592))
* remove unused popup classes ([#4792](https://github.com/gkatsev/videojs-release-test/issues/4792)) ([295889b](https://github.com/gkatsev/videojs-release-test/commit/295889b)), closes [#4725](https://github.com/gkatsev/videojs-release-test/issues/4725)
* switch to node 8 ([#4813](https://github.com/gkatsev/videojs-release-test/issues/4813)) ([f6f996d](https://github.com/gkatsev/videojs-release-test/commit/f6f996d))
* switch to videojs-generate-karma-config ([#5528](https://github.com/gkatsev/videojs-release-test/issues/5528)) ([2e70450](https://github.com/gkatsev/videojs-release-test/commit/2e70450))
* update all the dev deps to their latest versions ([#5645](https://github.com/gkatsev/videojs-release-test/issues/5645)) ([db1369a](https://github.com/gkatsev/videojs-release-test/commit/db1369a)), closes [#5644](https://github.com/gkatsev/videojs-release-test/issues/5644) [#5643](https://github.com/gkatsev/videojs-release-test/issues/5643)
* use relative urls in index.html ([#5586](https://github.com/gkatsev/videojs-release-test/issues/5586)) ([dec31e4](https://github.com/gkatsev/videojs-release-test/commit/dec31e4))
* **package:** update babelify to version 8.0.0 ([#4684](https://github.com/gkatsev/videojs-release-test/issues/4684)) ([db2f14c](https://github.com/gkatsev/videojs-release-test/commit/db2f14c))
* **package:** update grunt-browserify to version 5.2.0 ([#4578](https://github.com/gkatsev/videojs-release-test/issues/4578)) ([6cd785a](https://github.com/gkatsev/videojs-release-test/commit/6cd785a))
* **package:** update grunt-contrib-cssmin to version 2.2.0 ([#4345](https://github.com/gkatsev/videojs-release-test/issues/4345)) ([d57f09f](https://github.com/gkatsev/videojs-release-test/commit/d57f09f))
* **package:** update klaw-sync to version 3.0.0 ([#4544](https://github.com/gkatsev/videojs-release-test/issues/4544)) ([6233d14](https://github.com/gkatsev/videojs-release-test/commit/6233d14))
* **package:** update remark-cli to version 4.0.0 ([#4508](https://github.com/gkatsev/videojs-release-test/issues/4508)) ([7c80e13](https://github.com/gkatsev/videojs-release-test/commit/7c80e13))
* **package:** update remark-parse to version 4.0.0 ([#4507](https://github.com/gkatsev/videojs-release-test/issues/4507)) ([abb5d67](https://github.com/gkatsev/videojs-release-test/commit/abb5d67))
* **package:** update remark-stringify to version 4.0.0 ([#4506](https://github.com/gkatsev/videojs-release-test/issues/4506)) ([bbd92ab](https://github.com/gkatsev/videojs-release-test/commit/bbd92ab))
* **package:** update remark-toc to version 5.0.0 ([#4803](https://github.com/gkatsev/videojs-release-test/issues/4803)) ([0fa8c84](https://github.com/gkatsev/videojs-release-test/commit/0fa8c84))
* **package:** update remark-validate-links to version 7.0.0 ([#4585](https://github.com/gkatsev/videojs-release-test/issues/4585)) ([7929677](https://github.com/gkatsev/videojs-release-test/commit/7929677))
* **package:** update rollup to version 0.42.0 ([#4392](https://github.com/gkatsev/videojs-release-test/issues/4392)) ([f87b12c](https://github.com/gkatsev/videojs-release-test/commit/f87b12c))
* **package:** update rollup to version 0.45.2 ([#4487](https://github.com/gkatsev/videojs-release-test/issues/4487)) ([971f633](https://github.com/gkatsev/videojs-release-test/commit/971f633)), closes [#4475](https://github.com/gkatsev/videojs-release-test/issues/4475)
* **package:** update rollup to version 0.47.4 ([#4570](https://github.com/gkatsev/videojs-release-test/issues/4570)) ([d7f7e05](https://github.com/gkatsev/videojs-release-test/commit/d7f7e05)), closes [#4561](https://github.com/gkatsev/videojs-release-test/issues/4561)
* **package:** update rollup to version 0.47.5 ([#4572](https://github.com/gkatsev/videojs-release-test/issues/4572)) ([7b251d0](https://github.com/gkatsev/videojs-release-test/commit/7b251d0))
* **rollup:** fix watch build with globals/externals ([#5519](https://github.com/gkatsev/videojs-release-test/issues/5519)) ([401fa28](https://github.com/gkatsev/videojs-release-test/commit/401fa28))
* **travis:** remove unused secret variables ([#5577](https://github.com/gkatsev/videojs-release-test/issues/5577)) ([15beea7](https://github.com/gkatsev/videojs-release-test/commit/15beea7))
* add slack travis notifications ([#4282](https://github.com/gkatsev/videojs-release-test/issues/4282)) ([7490a49](https://github.com/gkatsev/videojs-release-test/commit/7490a49))
* Fix examples and docs and some links ([#4279](https://github.com/gkatsev/videojs-release-test/issues/4279)) ([f773c47](https://github.com/gkatsev/videojs-release-test/commit/f773c47))
* gitignore all npm-debug.log.* ([#4252](https://github.com/gkatsev/videojs-release-test/issues/4252)) ([083f643](https://github.com/gkatsev/videojs-release-test/commit/083f643))
* move scss grunt tasks to npm scripts ([#5520](https://github.com/gkatsev/videojs-release-test/issues/5520)) ([5f73f76](https://github.com/gkatsev/videojs-release-test/commit/5f73f76))
* remove bower.json ([#4238](https://github.com/gkatsev/videojs-release-test/issues/4238)) ([0d19a05](https://github.com/gkatsev/videojs-release-test/commit/0d19a05)), closes [#4012](https://github.com/gkatsev/videojs-release-test/issues/4012)
* remove rollup filesize plugin to double build speed ([#5518](https://github.com/gkatsev/videojs-release-test/issues/5518)) ([a9ae77f](https://github.com/gkatsev/videojs-release-test/commit/a9ae77f))
* switch to using chrome for testing PRs on travis ([#4462](https://github.com/gkatsev/videojs-release-test/issues/4462)) ([687aae5](https://github.com/gkatsev/videojs-release-test/commit/687aae5))
* typo soruce -> source ([#4307](https://github.com/gkatsev/videojs-release-test/issues/4307)) ([da1d861](https://github.com/gkatsev/videojs-release-test/commit/da1d861))
* update deps, remove coveralls, fix audit issues ([#5555](https://github.com/gkatsev/videojs-release-test/issues/5555)) ([11f1fb8](https://github.com/gkatsev/videojs-release-test/commit/11f1fb8))
* **babel:** Upgrade to Babel 7 ([#5498](https://github.com/gkatsev/videojs-release-test/issues/5498)) ([313036e](https://github.com/gkatsev/videojs-release-test/commit/313036e))
* **build:** fix rollup watch during npm start ([#5203](https://github.com/gkatsev/videojs-release-test/issues/5203)) ([6a94741](https://github.com/gkatsev/videojs-release-test/commit/6a94741))
* **changelog:** Update CHANGELOG with v5 changes ([#4257](https://github.com/gkatsev/videojs-release-test/issues/4257)) ([c20ca5c](https://github.com/gkatsev/videojs-release-test/commit/c20ca5c))
* **CHANGELOG:** update CHANGELOG from 6.x ([bca3167](https://github.com/gkatsev/videojs-release-test/commit/bca3167))
* **first-timers-bot:** add repo to bot options ([81de856](https://github.com/gkatsev/videojs-release-test/commit/81de856))
* **first-timers-bot:** correct the path to template file ([9612c8f](https://github.com/gkatsev/videojs-release-test/commit/9612c8f))
* **first-timers-bot:** fix slack url in template ([4e79a04](https://github.com/gkatsev/videojs-release-test/commit/4e79a04))
* **first-timers-bot:** quote repository option ([edb257c](https://github.com/gkatsev/videojs-release-test/commit/edb257c))
* **https:** update a lot of links to be https ([#5372](https://github.com/gkatsev/videojs-release-test/issues/5372)) ([9c00267](https://github.com/gkatsev/videojs-release-test/commit/9c00267))
* **lang:** update translations-needed doc ([#5459](https://github.com/gkatsev/videojs-release-test/issues/5459)) ([c2eb138](https://github.com/gkatsev/videojs-release-test/commit/c2eb138))
* **npmignore:** don't publish zip file to npm ([#5249](https://github.com/gkatsev/videojs-release-test/issues/5249)) ([5b8d373](https://github.com/gkatsev/videojs-release-test/commit/5b8d373)), closes [#5248](https://github.com/gkatsev/videojs-release-test/issues/5248)
* **package:** add module field to package.json ([#5293](https://github.com/gkatsev/videojs-release-test/issues/5293)) ([5d75bb6](https://github.com/gkatsev/videojs-release-test/commit/5d75bb6)), closes [#5288](https://github.com/gkatsev/videojs-release-test/issues/5288)
* **package:** remove npm-run dev dep as it's no longer used ([#5084](https://github.com/gkatsev/videojs-release-test/issues/5084)) ([c2b5ade](https://github.com/gkatsev/videojs-release-test/commit/c2b5ade))
* **package:** Run npm audit fix (but roll back videojs-standard version) ([#5386](https://github.com/gkatsev/videojs-release-test/issues/5386)) ([197d81b](https://github.com/gkatsev/videojs-release-test/commit/197d81b))
* **package:** update autoprefixer to version 9.0.1 ([#5340](https://github.com/gkatsev/videojs-release-test/issues/5340)) ([80bae72](https://github.com/gkatsev/videojs-release-test/commit/80bae72)), closes [#5322](https://github.com/gkatsev/videojs-release-test/issues/5322)
* **package:** update conventional-changelog-cli to version 2.0.1 🚀 ([#5236](https://github.com/gkatsev/videojs-release-test/issues/5236)) ([59ab323](https://github.com/gkatsev/videojs-release-test/commit/59ab323)), closes [#5225](https://github.com/gkatsev/videojs-release-test/issues/5225)
* **package:** update grunt-cli to version 1.3.1 ([#5409](https://github.com/gkatsev/videojs-release-test/issues/5409)) ([96ae3c2](https://github.com/gkatsev/videojs-release-test/commit/96ae3c2)), closes [#5383](https://github.com/gkatsev/videojs-release-test/issues/5383)
* **package:** update grunt-contrib-clean to version 2.0.0 🚀 ([#5429](https://github.com/gkatsev/videojs-release-test/issues/5429)) ([8191958](https://github.com/gkatsev/videojs-release-test/commit/8191958))
* **package:** update grunt-contrib-connect to version 2.0.0 🚀 ([#5428](https://github.com/gkatsev/videojs-release-test/issues/5428)) ([08cf1be](https://github.com/gkatsev/videojs-release-test/commit/08cf1be))
* **package:** update grunt-contrib-cssmin to version 3.0.0 🚀 ([#5417](https://github.com/gkatsev/videojs-release-test/issues/5417)) ([cc650f7](https://github.com/gkatsev/videojs-release-test/commit/cc650f7))
* **package:** update grunt-contrib-watch to version 1.1.0 🚀 ([#5170](https://github.com/gkatsev/videojs-release-test/issues/5170)) ([e8d00e2](https://github.com/gkatsev/videojs-release-test/commit/e8d00e2))
* **package:** update grunt-karma to version 3.0.0 🚀 ([#5421](https://github.com/gkatsev/videojs-release-test/issues/5421)) ([b390f2c](https://github.com/gkatsev/videojs-release-test/commit/b390f2c))
* **package:** update grunt-sass to version 3.0.2 🚀 ([#5486](https://github.com/gkatsev/videojs-release-test/issues/5486)) ([f9fcd14](https://github.com/gkatsev/videojs-release-test/commit/f9fcd14))
* **package:** update husky to version 1.0.1 🚀 ([#5448](https://github.com/gkatsev/videojs-release-test/issues/5448)) ([e50b193](https://github.com/gkatsev/videojs-release-test/commit/e50b193))
* **package:** update karma to version 2.0.2 🚀 ([#5109](https://github.com/gkatsev/videojs-release-test/issues/5109)) ([907c1f5](https://github.com/gkatsev/videojs-release-test/commit/907c1f5))
* **package:** update karma to version 3.0.0 🚀 ([#5370](https://github.com/gkatsev/videojs-release-test/issues/5370)) ([6893091](https://github.com/gkatsev/videojs-release-test/commit/6893091))
* **package:** update klaw-sync to version 4.0.0 🚀 ([#5130](https://github.com/gkatsev/videojs-release-test/issues/5130)) ([a6165d9](https://github.com/gkatsev/videojs-release-test/commit/a6165d9))
* **package:** update load-grunt-tasks to version 4.0.0 🚀 ([#5151](https://github.com/gkatsev/videojs-release-test/issues/5151)) ([83c3055](https://github.com/gkatsev/videojs-release-test/commit/83c3055))
* **package:** update remark-cli to version 6.0.0 🚀 ([#5516](https://github.com/gkatsev/videojs-release-test/issues/5516)) ([29005e9](https://github.com/gkatsev/videojs-release-test/commit/29005e9))
* **package:** update remark-parse to version 6.0.0 🚀 ([#5514](https://github.com/gkatsev/videojs-release-test/issues/5514)) ([d8e88cf](https://github.com/gkatsev/videojs-release-test/commit/d8e88cf))
* **package:** update remark-stringify to version 6.0.0 🚀 ([#5515](https://github.com/gkatsev/videojs-release-test/issues/5515)) ([8fa2f8a](https://github.com/gkatsev/videojs-release-test/commit/8fa2f8a))
* switch to prepublishOnly npm script to prevent build on npm ci ([#5497](https://github.com/gkatsev/videojs-release-test/issues/5497)) ([59adeb3](https://github.com/gkatsev/videojs-release-test/commit/59adeb3))
* **package:** update klaw-sync to version 5.0.0 🚀 ([#5414](https://github.com/gkatsev/videojs-release-test/issues/5414)) ([2e83888](https://github.com/gkatsev/videojs-release-test/commit/2e83888))
* **package:** update klaw-sync to version 6.0.0 🚀 ([#5445](https://github.com/gkatsev/videojs-release-test/issues/5445)) ([55f2b15](https://github.com/gkatsev/videojs-release-test/commit/55f2b15))
* **package:** update postcss-cli to version 6.0.0 🚀 ([#5329](https://github.com/gkatsev/videojs-release-test/issues/5329)) ([f273873](https://github.com/gkatsev/videojs-release-test/commit/f273873))
* **package:** update rollup to version 0.60.1 🚀 ([#5235](https://github.com/gkatsev/videojs-release-test/issues/5235)) ([1b0ff8a](https://github.com/gkatsev/videojs-release-test/commit/1b0ff8a)), closes [#5232](https://github.com/gkatsev/videojs-release-test/issues/5232)
* **package:** update rollup to version 0.61.1 ([#5268](https://github.com/gkatsev/videojs-release-test/issues/5268)) ([5c15d48](https://github.com/gkatsev/videojs-release-test/commit/5c15d48))
* **package:** update rollup to version 0.62.0 🚀 ([#5279](https://github.com/gkatsev/videojs-release-test/issues/5279)) ([2d7a4d7](https://github.com/gkatsev/videojs-release-test/commit/2d7a4d7))
* **package:** update rollup to version 0.63.4 ([#5341](https://github.com/gkatsev/videojs-release-test/issues/5341)) ([391434d](https://github.com/gkatsev/videojs-release-test/commit/391434d)), closes [#5326](https://github.com/gkatsev/videojs-release-test/issues/5326)
* **package:** update rollup to version 0.64.1 ([#5367](https://github.com/gkatsev/videojs-release-test/issues/5367)) ([16f4e92](https://github.com/gkatsev/videojs-release-test/commit/16f4e92)), closes [#5363](https://github.com/gkatsev/videojs-release-test/issues/5363)
* **package:** update rollup to version 0.65.0 🚀 ([#5400](https://github.com/gkatsev/videojs-release-test/issues/5400)) ([6e6ade0](https://github.com/gkatsev/videojs-release-test/commit/6e6ade0))
* **package:** update rollup to version 0.66.0 🚀 ([#5439](https://github.com/gkatsev/videojs-release-test/issues/5439)) ([3d72660](https://github.com/gkatsev/videojs-release-test/commit/3d72660))
* **package:** update rollup-plugin-filesize to version 2.0.0 🚀 ([#5234](https://github.com/gkatsev/videojs-release-test/issues/5234)) ([781d9ae](https://github.com/gkatsev/videojs-release-test/commit/781d9ae))
* **package:** update rollup-plugin-json to version 3.0.0 🚀 ([#5169](https://github.com/gkatsev/videojs-release-test/issues/5169)) ([de9c4da](https://github.com/gkatsev/videojs-release-test/commit/de9c4da))
* **package:** update rollup-watch to version 4.0.0 ([#4396](https://github.com/gkatsev/videojs-release-test/issues/4396)) ([4bce4a2](https://github.com/gkatsev/videojs-release-test/commit/4bce4a2))
* **package:** update unified to version 7.0.0 🚀 ([#5166](https://github.com/gkatsev/videojs-release-test/issues/5166)) ([5407381](https://github.com/gkatsev/videojs-release-test/commit/5407381))
* **package:** Upgrade [@videojs](https://github.com/videojs)/http-streaming to 1.0.2 ([#5189](https://github.com/gkatsev/videojs-release-test/issues/5189)) ([eaf1516](https://github.com/gkatsev/videojs-release-test/commit/eaf1516)), closes [#5186](https://github.com/gkatsev/videojs-release-test/issues/5186)
* **package:** upgrade rollup to 0.66.2 ([#5458](https://github.com/gkatsev/videojs-release-test/issues/5458)) ([426e210](https://github.com/gkatsev/videojs-release-test/commit/426e210))
* **package:** upgrade to VHS 1.1.0 ([#5305](https://github.com/gkatsev/videojs-release-test/issues/5305)) ([da5a590](https://github.com/gkatsev/videojs-release-test/commit/da5a590))
* **package-lock:** update to npm 6.4.1 & node 8.12 ([565b750](https://github.com/gkatsev/videojs-release-test/commit/565b750))
* **test:** upgrade qunit and karma-qunit to latest ([#5051](https://github.com/gkatsev/videojs-release-test/issues/5051)) ([44312bc](https://github.com/gkatsev/videojs-release-test/commit/44312bc))
* **welcome bot:** add welcome bot config ([#5313](https://github.com/gkatsev/videojs-release-test/issues/5313)) ([e637768](https://github.com/gkatsev/videojs-release-test/commit/e637768))
* enable move and stale probots ([#5292](https://github.com/gkatsev/videojs-release-test/issues/5292)) ([00bb788](https://github.com/gkatsev/videojs-release-test/commit/00bb788))
* update package-lock.json ([9519740](https://github.com/gkatsev/videojs-release-test/commit/9519740))
* update rollup and uglify and the build process ([#5096](https://github.com/gkatsev/videojs-release-test/issues/5096)) ([97db94e](https://github.com/gkatsev/videojs-release-test/commit/97db94e))
* **sandbox:** Fix paths in sandbox files. ([#4416](https://github.com/gkatsev/videojs-release-test/issues/4416)) ([c4bbe5d](https://github.com/gkatsev/videojs-release-test/commit/c4bbe5d))
* ignore qunit and sinon from greenkeeper ([#4242](https://github.com/gkatsev/videojs-release-test/issues/4242)) ([29d733d](https://github.com/gkatsev/videojs-release-test/commit/29d733d))
* update translations needed ([#4380](https://github.com/gkatsev/videojs-release-test/issues/4380)) ([a5a68e8](https://github.com/gkatsev/videojs-release-test/commit/a5a68e8))
* **changelog.md:** update 5.12.6 and 5.12.3 ([#3715](https://github.com/gkatsev/videojs-release-test/issues/3715)) ([254683b](https://github.com/gkatsev/videojs-release-test/commit/254683b))
* **deps:** add the bundle-collapser browserify plugin ([816291e](https://github.com/gkatsev/videojs-release-test/commit/816291e))
* **development:** fix `npm start` file watching ([#3922](https://github.com/gkatsev/videojs-release-test/issues/3922)) ([02da697](https://github.com/gkatsev/videojs-release-test/commit/02da697))
* **docs:** Documentation Linting and TOC generation ([#3841](https://github.com/gkatsev/videojs-release-test/issues/3841)) ([0493f54](https://github.com/gkatsev/videojs-release-test/commit/0493f54))
* **docs:** Use Elephants Dream video files from CDN for docs/examples/elephantsdream/ ([#4181](https://github.com/gkatsev/videojs-release-test/issues/4181)) ([af1c6e3](https://github.com/gkatsev/videojs-release-test/commit/af1c6e3))
* **faq:** move FAQ and troubleshooting guide to docs/ ([#3883](https://github.com/gkatsev/videojs-release-test/issues/3883)) ([26789e7](https://github.com/gkatsev/videojs-release-test/commit/26789e7))
* **grunt:** fix getting changelog by switching to  npm-run ([#3687](https://github.com/gkatsev/videojs-release-test/issues/3687)) ([8845bd3](https://github.com/gkatsev/videojs-release-test/commit/8845bd3)), closes [#3683](https://github.com/gkatsev/videojs-release-test/issues/3683)
* **package:** pin karma to 1.3.0 ([#4002](https://github.com/gkatsev/videojs-release-test/issues/4002)) ([5b8b41e](https://github.com/gkatsev/videojs-release-test/commit/5b8b41e))
* **package:** remove es2015-loose since it's an option for es2015 ([#3629](https://github.com/gkatsev/videojs-release-test/issues/3629)) ([c545acd](https://github.com/gkatsev/videojs-release-test/commit/c545acd))
* **package:** update dependencies (enable Greenkeeper) 🌴 ([#3777](https://github.com/gkatsev/videojs-release-test/issues/3777)) ([d20e9ce](https://github.com/gkatsev/videojs-release-test/commit/d20e9ce))
* **package:** update grunt-accessibility to version 5.0.0 ([#3747](https://github.com/gkatsev/videojs-release-test/issues/3747)) ([b6d521f](https://github.com/gkatsev/videojs-release-test/commit/b6d521f))
* **package:** update grunt-contrib-cssmin to version 1.0.2 ([#3595](https://github.com/gkatsev/videojs-release-test/issues/3595)) ([54e3db5](https://github.com/gkatsev/videojs-release-test/commit/54e3db5))
* **package:** update grunt-shell to version 2.0.0 ([#3642](https://github.com/gkatsev/videojs-release-test/issues/3642)) ([2032b17](https://github.com/gkatsev/videojs-release-test/commit/2032b17))
* **package:** update karma-detect-browsers to version 2.2.3 ([#3770](https://github.com/gkatsev/videojs-release-test/issues/3770)) ([6b477bb](https://github.com/gkatsev/videojs-release-test/commit/6b477bb))
* **package:** update remark-cli to version 3.0.0 ([#4126](https://github.com/gkatsev/videojs-release-test/issues/4126)) ([dc9ed1c](https://github.com/gkatsev/videojs-release-test/commit/dc9ed1c))
* **package:** update remark-lint to version 6.0.0 ([#4129](https://github.com/gkatsev/videojs-release-test/issues/4129)) ([9ef2d07](https://github.com/gkatsev/videojs-release-test/commit/9ef2d07))
* **package:** update remark-toc to version 4.0.0 ([#4127](https://github.com/gkatsev/videojs-release-test/issues/4127)) ([d5a619d](https://github.com/gkatsev/videojs-release-test/commit/d5a619d))
* **package:** update remark-validate-links to version 6.0.0 ([#4128](https://github.com/gkatsev/videojs-release-test/issues/4128)) ([1395677](https://github.com/gkatsev/videojs-release-test/commit/1395677))
* **package:** update uglify-js to version 2.8.8 ([#4170](https://github.com/gkatsev/videojs-release-test/issues/4170)) ([bf787bd](https://github.com/gkatsev/videojs-release-test/commit/bf787bd)), closes [#4138](https://github.com/gkatsev/videojs-release-test/issues/4138)
* **package:** update videojs-flash to version 2.0.0 ([#4375](https://github.com/gkatsev/videojs-release-test/issues/4375)) ([9816070](https://github.com/gkatsev/videojs-release-test/commit/9816070))
* **package:** update videojs-vtt.js to version 0.12.3 ([#4221](https://github.com/gkatsev/videojs-release-test/issues/4221)) ([7d12c9e](https://github.com/gkatsev/videojs-release-test/commit/7d12c9e))
* **package:** update webpack to version 2.3.0 ([#4219](https://github.com/gkatsev/videojs-release-test/issues/4219)) ([0223057](https://github.com/gkatsev/videojs-release-test/commit/0223057))
* **sandbox:** Fix poster image to match the video in the 'combined-tracks.html' example in sandbox ([#4164](https://github.com/gkatsev/videojs-release-test/issues/4164)) ([5ffe1cd](https://github.com/gkatsev/videojs-release-test/commit/5ffe1cd))
* **test:** silence plugin warning from test ([#4173](https://github.com/gkatsev/videojs-release-test/issues/4173)) ([05e6494](https://github.com/gkatsev/videojs-release-test/commit/05e6494))
* **tests:** make tests not print out errors ([#4141](https://github.com/gkatsev/videojs-release-test/issues/4141)) ([f95815b](https://github.com/gkatsev/videojs-release-test/commit/f95815b))
* better dev experience ([#3896](https://github.com/gkatsev/videojs-release-test/issues/3896)) ([9ec5587](https://github.com/gkatsev/videojs-release-test/commit/9ec5587))
* change accessibility test in grunt.js to remove unnecessary warning message. ([#4143](https://github.com/gkatsev/videojs-release-test/issues/4143)) ([dacf0ca](https://github.com/gkatsev/videojs-release-test/commit/dacf0ca))
* don't run tests on travis if only docs were changed ([#3908](https://github.com/gkatsev/videojs-release-test/issues/3908)) ([c239bd5](https://github.com/gkatsev/videojs-release-test/commit/c239bd5))
* fix typo in collaborator guide ([#3931](https://github.com/gkatsev/videojs-release-test/issues/3931)) ([f35de1c](https://github.com/gkatsev/videojs-release-test/commit/f35de1c))
* increase browserstack/karma timeouts, dispose player in tests ([#4135](https://github.com/gkatsev/videojs-release-test/issues/4135)) ([6874fa2](https://github.com/gkatsev/videojs-release-test/commit/6874fa2))
* **pr_template:** add checkbox to verify changes in a browser ([#3775](https://github.com/gkatsev/videojs-release-test/issues/3775)) ([72fcb6c](https://github.com/gkatsev/videojs-release-test/commit/72fcb6c))
* **sandbox:** Use Elephants Dream video files from CDN for the sandbox/descriptions.html.example. ([#4137](https://github.com/gkatsev/videojs-release-test/issues/4137)) ([715f584](https://github.com/gkatsev/videojs-release-test/commit/715f584))
* Add flash as a dev dependency for testing ([#4016](https://github.com/gkatsev/videojs-release-test/issues/4016)) ([4949619](https://github.com/gkatsev/videojs-release-test/commit/4949619))
* fixup CHANGELOG for 5.13.1 release ([2a05633](https://github.com/gkatsev/videojs-release-test/commit/2a05633))
* move metadata to hidden folder and update references ([86f0830](https://github.com/gkatsev/videojs-release-test/commit/86f0830))
* only report errors during linting in the build process, not warnings ([#4041](https://github.com/gkatsev/videojs-release-test/issues/4041)) ([6208e4b](https://github.com/gkatsev/videojs-release-test/commit/6208e4b))
* refactor redundant code in html5 tech ([#3593](https://github.com/gkatsev/videojs-release-test/issues/3593)) ([6878c21](https://github.com/gkatsev/videojs-release-test/commit/6878c21))
* refactor redundant or verbose code in player.js ([#3597](https://github.com/gkatsev/videojs-release-test/issues/3597)) ([ae3e277](https://github.com/gkatsev/videojs-release-test/commit/ae3e277))
* switch from ghooks to husky ([#4074](https://github.com/gkatsev/videojs-release-test/issues/4074)) ([c3b1d68](https://github.com/gkatsev/videojs-release-test/commit/c3b1d68))
* **package:** update xhr to version 2.3.3 ([#3914](https://github.com/gkatsev/videojs-release-test/issues/3914)) ([924fb27](https://github.com/gkatsev/videojs-release-test/commit/924fb27))
* pin karma-detect-browsers to 2.1.0 ([#3764](https://github.com/gkatsev/videojs-release-test/issues/3764)) ([4859bb9](https://github.com/gkatsev/videojs-release-test/commit/4859bb9))
* Remove component.json and remove references to it ([#3866](https://github.com/gkatsev/videojs-release-test/issues/3866)) ([0bba319](https://github.com/gkatsev/videojs-release-test/commit/0bba319))
* **release:** add es5 folder to the tagged commit ([#3913](https://github.com/gkatsev/videojs-release-test/issues/3913)) ([d120ea2](https://github.com/gkatsev/videojs-release-test/commit/d120ea2))
* **sass:** upgrade to latest version of grunt-sass ([#3897](https://github.com/gkatsev/videojs-release-test/issues/3897)) ([83d453b](https://github.com/gkatsev/videojs-release-test/commit/83d453b)), closes [#3692](https://github.com/gkatsev/videojs-release-test/issues/3692)
* **videojs-standard:** update to version 6.0.1 ([#3884](https://github.com/gkatsev/videojs-release-test/issues/3884)) ([eb389c5](https://github.com/gkatsev/videojs-release-test/commit/eb389c5))
* fix CHANGELOG 5.13.1 header ([23f0fa0](https://github.com/gkatsev/videojs-release-test/commit/23f0fa0))
* update CHANGELOG automation to use conventional-changelog ([#3669](https://github.com/gkatsev/videojs-release-test/issues/3669)) ([d4e89d2](https://github.com/gkatsev/videojs-release-test/commit/d4e89d2))
* update object.assign to ^4.0.4 ([08c7f4e](https://github.com/gkatsev/videojs-release-test/commit/08c7f4e))

### Code Refactoring

* use the new `any` event function ([#6080](https://github.com/gkatsev/videojs-release-test/issues/6080)) ([3c932c5](https://github.com/gkatsev/videojs-release-test/commit/3c932c5))
* **pip:** rely only on WICG spec events ([#6064](https://github.com/gkatsev/videojs-release-test/issues/6064)) ([10ed08a](https://github.com/gkatsev/videojs-release-test/commit/10ed08a))
* Buttons will always use a button element ([#3828](https://github.com/gkatsev/videojs-release-test/issues/3828)) ([c340dbc](https://github.com/gkatsev/videojs-release-test/commit/c340dbc))
* component.ready() ([#4693](https://github.com/gkatsev/videojs-release-test/issues/4693)) ([b40858b](https://github.com/gkatsev/videojs-release-test/commit/b40858b))
* Create a base time display class, and use it ([#4633](https://github.com/gkatsev/videojs-release-test/issues/4633)) ([fa6f884](https://github.com/gkatsev/videojs-release-test/commit/fa6f884))
* do not allow adding children with options passed in as a boolean ([#3872](https://github.com/gkatsev/videojs-release-test/issues/3872)) ([b07143d](https://github.com/gkatsev/videojs-release-test/commit/b07143d))
* Evented Components ([#3959](https://github.com/gkatsev/videojs-release-test/issues/3959)) ([4c3b60c](https://github.com/gkatsev/videojs-release-test/commit/4c3b60c))
* expose tech but warn without safety var ([#3916](https://github.com/gkatsev/videojs-release-test/issues/3916)) ([8622b26](https://github.com/gkatsev/videojs-release-test/commit/8622b26))
* Make registerComponent only work with Components ([#3802](https://github.com/gkatsev/videojs-release-test/issues/3802)) ([57af15c](https://github.com/gkatsev/videojs-release-test/commit/57af15c))
* move most volume panel functionality into css state ([#3981](https://github.com/gkatsev/videojs-release-test/issues/3981)) ([2e2ac6f](https://github.com/gkatsev/videojs-release-test/commit/2e2ac6f))
* move seekbar event handler bindings into a function ([#5097](https://github.com/gkatsev/videojs-release-test/issues/5097)) ([1069e7f](https://github.com/gkatsev/videojs-release-test/commit/1069e7f))
* move sourceset code out of tech ([#5037](https://github.com/gkatsev/videojs-release-test/issues/5037)) ([1cb67ab](https://github.com/gkatsev/videojs-release-test/commit/1cb67ab))
* MuteToggle#update ([#4058](https://github.com/gkatsev/videojs-release-test/issues/4058)) ([a04f387](https://github.com/gkatsev/videojs-release-test/commit/a04f387))
* player.controls() ([#4731](https://github.com/gkatsev/videojs-release-test/issues/4731)) ([d447e9f](https://github.com/gkatsev/videojs-release-test/commit/d447e9f))
* player.dimension() ([#4704](https://github.com/gkatsev/videojs-release-test/issues/4704)) ([ad1b47b](https://github.com/gkatsev/videojs-release-test/commit/ad1b47b))
* player.hasStarted() ([#4680](https://github.com/gkatsev/videojs-release-test/issues/4680)) ([cde8335](https://github.com/gkatsev/videojs-release-test/commit/cde8335))
* player.listenForUserActivity_() ([#4719](https://github.com/gkatsev/videojs-release-test/issues/4719)) ([c16fedf](https://github.com/gkatsev/videojs-release-test/commit/c16fedf))
* player.techGet_() ([#4687](https://github.com/gkatsev/videojs-release-test/issues/4687)) ([a1748aa](https://github.com/gkatsev/videojs-release-test/commit/a1748aa))
* player.userActive() ([#4716](https://github.com/gkatsev/videojs-release-test/issues/4716)) ([6cbe3ed](https://github.com/gkatsev/videojs-release-test/commit/6cbe3ed))
* player.usingNativeControls() ([#4749](https://github.com/gkatsev/videojs-release-test/issues/4749)) ([eb909f0](https://github.com/gkatsev/videojs-release-test/commit/eb909f0))
* Remove custom UMD ([#3826](https://github.com/gkatsev/videojs-release-test/issues/3826)) ([2014120](https://github.com/gkatsev/videojs-release-test/commit/2014120))
* Remove deprecated features of extend/Component#extend ([#3825](https://github.com/gkatsev/videojs-release-test/issues/3825)) ([f8aed4d](https://github.com/gkatsev/videojs-release-test/commit/f8aed4d))
* remove IE8 specific changes ([#5041](https://github.com/gkatsev/videojs-release-test/issues/5041)) ([bc2da7c](https://github.com/gkatsev/videojs-release-test/commit/bc2da7c))
* Remove method Chaining from videojs ([#3860](https://github.com/gkatsev/videojs-release-test/issues/3860)) ([8f07f5d](https://github.com/gkatsev/videojs-release-test/commit/8f07f5d))
* remove special loadstart handling ([#3906](https://github.com/gkatsev/videojs-release-test/issues/3906)) ([73b6316](https://github.com/gkatsev/videojs-release-test/commit/73b6316))
* Remove TimeRanges without an index deprecation warning ([#3827](https://github.com/gkatsev/videojs-release-test/issues/3827)) ([e12bedb](https://github.com/gkatsev/videojs-release-test/commit/e12bedb))
* remove un-needed contructor and function overrides ([#3721](https://github.com/gkatsev/videojs-release-test/issues/3721)) ([6889e92](https://github.com/gkatsev/videojs-release-test/commit/6889e92))
* Remove unused defaultVolume option default ([#3915](https://github.com/gkatsev/videojs-release-test/issues/3915)) ([5377ffc](https://github.com/gkatsev/videojs-release-test/commit/5377ffc))
* removed old bug work-around code ([#5200](https://github.com/gkatsev/videojs-release-test/issues/5200)) ([ceed382](https://github.com/gkatsev/videojs-release-test/commit/ceed382))
* require `videojs-vtt.js` via require rather than concat ([#3919](https://github.com/gkatsev/videojs-release-test/issues/3919)) ([d290db1](https://github.com/gkatsev/videojs-release-test/commit/d290db1))
* switch to fullscreen.options ([#6054](https://github.com/gkatsev/videojs-release-test/issues/6054)) ([2977d52](https://github.com/gkatsev/videojs-release-test/commit/2977d52))
* unify all Track and TrackList APIs ([#3783](https://github.com/gkatsev/videojs-release-test/issues/3783)) ([49bed07](https://github.com/gkatsev/videojs-release-test/commit/49bed07))
* **html5:** remove confusing references to player in a tech ([#3790](https://github.com/gkatsev/videojs-release-test/issues/3790)) ([d69551a](https://github.com/gkatsev/videojs-release-test/commit/d69551a))
* **texttracksettings:** DRYer code and remove massive HTML blob ([#3679](https://github.com/gkatsev/videojs-release-test/issues/3679)) ([fb74c71](https://github.com/gkatsev/videojs-release-test/commit/fb74c71))

### Documentation

* add an example Vue integration.md ([#5899](https://github.com/gkatsev/videojs-release-test/issues/5899)) ([4c277fd](https://github.com/gkatsev/videojs-release-test/commit/4c277fd))
* add note about SubsCapsButton only showing up when configured with text tracks ([#6254](https://github.com/gkatsev/videojs-release-test/issues/6254)) ([f34d441](https://github.com/gkatsev/videojs-release-test/commit/f34d441))
* emphasize src object and video-js element ([#5960](https://github.com/gkatsev/videojs-release-test/issues/5960)) ([e1afa3e](https://github.com/gkatsev/videojs-release-test/commit/e1afa3e))
* fixes the return value type of the loop method. ([#5789](https://github.com/gkatsev/videojs-release-test/issues/5789)) ([65beb5a](https://github.com/gkatsev/videojs-release-test/commit/65beb5a))
* remove grunt and update usage of build scripts ([#5656](https://github.com/gkatsev/videojs-release-test/issues/5656)) ([62f9e78](https://github.com/gkatsev/videojs-release-test/commit/62f9e78))
* update Components list ([#6253](https://github.com/gkatsev/videojs-release-test/issues/6253)) ([7a85e2a](https://github.com/gkatsev/videojs-release-test/commit/7a85e2a)), closes [#5980](https://github.com/gkatsev/videojs-release-test/issues/5980)
* Update format information ([#5783](https://github.com/gkatsev/videojs-release-test/issues/5783)) ([76cc310](https://github.com/gkatsev/videojs-release-test/commit/76cc310))
* update guides markdown ([#6063](https://github.com/gkatsev/videojs-release-test/issues/6063)) ([cf6e0e8](https://github.com/gkatsev/videojs-release-test/commit/cf6e0e8))
* **audiotracks:** correct typo ([#5816](https://github.com/gkatsev/videojs-release-test/issues/5816)) ([e612056](https://github.com/gkatsev/videojs-release-test/commit/e612056))
* **collaborator-guide:** Clarify how to Land a PR using the GitHub UI ([#5201](https://github.com/gkatsev/videojs-release-test/issues/5201)) ([94e54fc](https://github.com/gkatsev/videojs-release-test/commit/94e54fc))
* **component:** fix misspellings ([#5017](https://github.com/gkatsev/videojs-release-test/issues/5017)) ([1532df3](https://github.com/gkatsev/videojs-release-test/commit/1532df3))
* **component:** fix misspelllings ([#5019](https://github.com/gkatsev/videojs-release-test/issues/5019)) ([ebbe868](https://github.com/gkatsev/videojs-release-test/commit/ebbe868))
* **component:** fix typo ([#5226](https://github.com/gkatsev/videojs-release-test/issues/5226)) ([a3fd06a](https://github.com/gkatsev/videojs-release-test/commit/a3fd06a))
* **debugging:** fix markup typo ([#5086](https://github.com/gkatsev/videojs-release-test/issues/5086)) ([4399bdc](https://github.com/gkatsev/videojs-release-test/commit/4399bdc))
* **examples:** remove IE9 text track HTML markup in the doc/examples, and update to use video.js v7.0 ([#5192](https://github.com/gkatsev/videojs-release-test/issues/5192)) ([f5a6e61](https://github.com/gkatsev/videojs-release-test/commit/f5a6e61))
* **fixup:** fixup docs ([#5489](https://github.com/gkatsev/videojs-release-test/issues/5489)) ([794cd71](https://github.com/gkatsev/videojs-release-test/commit/794cd71))
* **guides:** add debugging section to index ([#5100](https://github.com/gkatsev/videojs-release-test/issues/5100)) ([62c1477](https://github.com/gkatsev/videojs-release-test/commit/62c1477))
* **hotkeys:** hotkeys require player focus ([#5859](https://github.com/gkatsev/videojs-release-test/issues/5859)) ([a271eca](https://github.com/gkatsev/videojs-release-test/commit/a271eca)), closes [#5832](https://github.com/gkatsev/videojs-release-test/issues/5832)
* **languages:** Use valid JSON in translation example ([#5080](https://github.com/gkatsev/videojs-release-test/issues/5080)) ([bec7f67](https://github.com/gkatsev/videojs-release-test/commit/bec7f67))
* **live:** minor spelling/grammar corrections ([#5894](https://github.com/gkatsev/videojs-release-test/issues/5894)) ([6c644fe](https://github.com/gkatsev/videojs-release-test/commit/6c644fe))
* **media-error:** Correct error type documentation ([#5566](https://github.com/gkatsev/videojs-release-test/issues/5566)) ([441f0e1](https://github.com/gkatsev/videojs-release-test/commit/441f0e1))
* **middleware:** update the middleware guide with setTech and other corrections ([#4926](https://github.com/gkatsev/videojs-release-test/issues/4926)) ([a434551](https://github.com/gkatsev/videojs-release-test/commit/a434551))
* **ModalDialog:** add missing documentation for pauseOnOpen ([#5908](https://github.com/gkatsev/videojs-release-test/issues/5908)) ([b2eae7b](https://github.com/gkatsev/videojs-release-test/commit/b2eae7b))
* add middleware guide ([#4877](https://github.com/gkatsev/videojs-release-test/issues/4877)) ([673c231](https://github.com/gkatsev/videojs-release-test/commit/673c231))
* clarify text tracks are meant for any usage of Video.js, both video and audio ([#4790](https://github.com/gkatsev/videojs-release-test/issues/4790)) ([1672a6d](https://github.com/gkatsev/videojs-release-test/commit/1672a6d))
* deploy docs using netlify ([#4774](https://github.com/gkatsev/videojs-release-test/issues/4774)) ([4dd000c](https://github.com/gkatsev/videojs-release-test/commit/4dd000c)), closes [#4609](https://github.com/gkatsev/videojs-release-test/issues/4609)
* remove duplicate `[@deprecated](https://github.com/deprecated)` which throws error when minifying via google closure compiler ([#5342](https://github.com/gkatsev/videojs-release-test/issues/5342)) ([d773cd4](https://github.com/gkatsev/videojs-release-test/commit/d773cd4))
* Update JSDoc comments, so core API docs for the videojs function are accurate. ([#5385](https://github.com/gkatsev/videojs-release-test/issues/5385)) ([ebf8d66](https://github.com/gkatsev/videojs-release-test/commit/ebf8d66))
* update readme to use the latest version of vjs ([#5073](https://github.com/gkatsev/videojs-release-test/issues/5073)) ([167b7d8](https://github.com/gkatsev/videojs-release-test/commit/167b7d8)), closes [#5066](https://github.com/gkatsev/videojs-release-test/issues/5066)
* use https links ([#5749](https://github.com/gkatsev/videojs-release-test/issues/5749)) ([4b11a4e](https://github.com/gkatsev/videojs-release-test/commit/4b11a4e))
* **liveui:** Add a guide for the live ui and live api ([#5677](https://github.com/gkatsev/videojs-release-test/issues/5677)) ([c147581](https://github.com/gkatsev/videojs-release-test/commit/c147581))
* update starter template ([#5570](https://github.com/gkatsev/videojs-release-test/issues/5570)) ([287b267](https://github.com/gkatsev/videojs-release-test/commit/287b267)), closes [1000#0](https://github.com/1000/issues/0) [#5562](https://github.com/gkatsev/videojs-release-test/issues/5562)
* Update urls in README.md to point to v7.3.0 ([#5536](https://github.com/gkatsev/videojs-release-test/issues/5536)) ([79edf5b](https://github.com/gkatsev/videojs-release-test/commit/79edf5b))
* **hooks:** Fix Typo ([#4652](https://github.com/gkatsev/videojs-release-test/issues/4652)) ([6738f76](https://github.com/gkatsev/videojs-release-test/commit/6738f76))
* **lang:** update translations needed doc ([#4702](https://github.com/gkatsev/videojs-release-test/issues/4702)) ([93e7670](https://github.com/gkatsev/videojs-release-test/commit/93e7670))
* **layout:** document fluid and fill mode ([#5481](https://github.com/gkatsev/videojs-release-test/issues/5481)) ([2e72fc3](https://github.com/gkatsev/videojs-release-test/commit/2e72fc3))
* **player:** make reset() method more clear ([#5501](https://github.com/gkatsev/videojs-release-test/issues/5501)) ([f66692e](https://github.com/gkatsev/videojs-release-test/commit/f66692e))
* **plugins guide:** changed paused to pause where appropriate ([#4957](https://github.com/gkatsev/videojs-release-test/issues/4957)) ([763a7f5](https://github.com/gkatsev/videojs-release-test/commit/763a7f5)), closes [#4951](https://github.com/gkatsev/videojs-release-test/issues/4951)
* **react:** Update docs for react tutorial ([#4935](https://github.com/gkatsev/videojs-release-test/issues/4935)) ([#4952](https://github.com/gkatsev/videojs-release-test/issues/4952)) ([7c30f97](https://github.com/gkatsev/videojs-release-test/commit/7c30f97))
* **readme:** fixed a typo ([#4730](https://github.com/gkatsev/videojs-release-test/issues/4730)) ([46a7df2](https://github.com/gkatsev/videojs-release-test/commit/46a7df2))
* **README:** refer to minified JS and CSS files, improve general layout ([#5494](https://github.com/gkatsev/videojs-release-test/issues/5494)) ([e671bc3](https://github.com/gkatsev/videojs-release-test/commit/e671bc3))
* **README:** update info about google analytics ([#5491](https://github.com/gkatsev/videojs-release-test/issues/5491)) ([7292253](https://github.com/gkatsev/videojs-release-test/commit/7292253)), closes [#5361](https://github.com/gkatsev/videojs-release-test/issues/5361)
* add a troubleshooting guide ([#3814](https://github.com/gkatsev/videojs-release-test/issues/3814)) ([54ff1f9](https://github.com/gkatsev/videojs-release-test/commit/54ff1f9))
* add a Webpack usage guide ([#4261](https://github.com/gkatsev/videojs-release-test/issues/4261)) ([230743e](https://github.com/gkatsev/videojs-release-test/commit/230743e))
* Add MediaLoader to components list ([#4070](https://github.com/gkatsev/videojs-release-test/issues/4070)) ([65dc81a](https://github.com/gkatsev/videojs-release-test/commit/65dc81a))
* Document how to add a version number to a plugin ([#4642](https://github.com/gkatsev/videojs-release-test/issues/4642)) ([85a34d1](https://github.com/gkatsev/videojs-release-test/commit/85a34d1))
* Document playbackRates ([#4602](https://github.com/gkatsev/videojs-release-test/issues/4602)) ([9d249bb](https://github.com/gkatsev/videojs-release-test/commit/9d249bb))
* Expand testing info in `CONTRIBUTING.md` ([#4020](https://github.com/gkatsev/videojs-release-test/issues/4020)) ([2da4e76](https://github.com/gkatsev/videojs-release-test/commit/2da4e76))
* fix broken links in docs index.md ([4063f96](https://github.com/gkatsev/videojs-release-test/commit/4063f96))
* fix broken links to guides in the faq ([#3973](https://github.com/gkatsev/videojs-release-test/issues/3973)) ([58f2349](https://github.com/gkatsev/videojs-release-test/commit/58f2349))
* Fix links in API docs for several Player events. ([#4427](https://github.com/gkatsev/videojs-release-test/issues/4427)) ([cc6e824](https://github.com/gkatsev/videojs-release-test/commit/cc6e824))
* fix links in generated docs ([#4200](https://github.com/gkatsev/videojs-release-test/issues/4200)) ([61e2078](https://github.com/gkatsev/videojs-release-test/commit/61e2078))
* fix more misspellings ([#5067](https://github.com/gkatsev/videojs-release-test/issues/5067)) ([7da7766](https://github.com/gkatsev/videojs-release-test/commit/7da7766))
* Fix Player#src API documentation. ([#4454](https://github.com/gkatsev/videojs-release-test/issues/4454)) ([7579fc1](https://github.com/gkatsev/videojs-release-test/commit/7579fc1))
* fix some misspellings ([#5082](https://github.com/gkatsev/videojs-release-test/issues/5082)) ([064c1be](https://github.com/gkatsev/videojs-release-test/commit/064c1be))
* **react guide:** update guide to prevent memory leaks when components are disposed of ([#4998](https://github.com/gkatsev/videojs-release-test/issues/4998)) ([1fa9dfb](https://github.com/gkatsev/videojs-release-test/commit/1fa9dfb))
* **tech:** fix misspellings ([#5059](https://github.com/gkatsev/videojs-release-test/issues/5059)) ([96987f8](https://github.com/gkatsev/videojs-release-test/commit/96987f8))
* **text-track:** fix misspellings ([#5058](https://github.com/gkatsev/videojs-release-test/issues/5058)) ([4d3331e](https://github.com/gkatsev/videojs-release-test/commit/4d3331e))
* **time-ranges:** fix misspellings ([#5025](https://github.com/gkatsev/videojs-release-test/issues/5025)) ([bd6b31c](https://github.com/gkatsev/videojs-release-test/commit/bd6b31c))
* **time-ranges:** fix misspellings ([#5046](https://github.com/gkatsev/videojs-release-test/issues/5046)) ([378d98e](https://github.com/gkatsev/videojs-release-test/commit/378d98e))
* **time-ranges:** fix wrong comment for getRange function ([#5026](https://github.com/gkatsev/videojs-release-test/issues/5026)) ([d7f45ba](https://github.com/gkatsev/videojs-release-test/commit/d7f45ba))
* fix some typos ([#4880](https://github.com/gkatsev/videojs-release-test/issues/4880)) ([83880b0](https://github.com/gkatsev/videojs-release-test/commit/83880b0))
* Fix the advance plugin example in documentation ([#4923](https://github.com/gkatsev/videojs-release-test/issues/4923)) ([4afabc2](https://github.com/gkatsev/videojs-release-test/commit/4afabc2))
* Fixing player.remoteTextTracks jsdoc ([#4417](https://github.com/gkatsev/videojs-release-test/issues/4417)) ([9329e3e](https://github.com/gkatsev/videojs-release-test/commit/9329e3e))
* fixup global jsdoc members ([#4015](https://github.com/gkatsev/videojs-release-test/issues/4015)) ([6ad1e5c](https://github.com/gkatsev/videojs-release-test/commit/6ad1e5c))
* make jsdoc generate anchor names so ToC links work ([#4471](https://github.com/gkatsev/videojs-release-test/issues/4471)) ([03fd402](https://github.com/gkatsev/videojs-release-test/commit/03fd402))
* minor fix to currentTime() comment: "setting" not "getting" ([#3944](https://github.com/gkatsev/videojs-release-test/issues/3944)) ([6578ed9](https://github.com/gkatsev/videojs-release-test/commit/6578ed9))
* move examples out of code into docs ([642ad4b](https://github.com/gkatsev/videojs-release-test/commit/642ad4b))
* ran `npm run docs:fix` to update TOC on guides ([#3971](https://github.com/gkatsev/videojs-release-test/issues/3971)) ([de3945d](https://github.com/gkatsev/videojs-release-test/commit/de3945d))
* remove mentions of bower support ([#4274](https://github.com/gkatsev/videojs-release-test/issues/4274)) ([39fd73f](https://github.com/gkatsev/videojs-release-test/commit/39fd73f)), closes [#4012](https://github.com/gkatsev/videojs-release-test/issues/4012)
* Update COLLABORATOR_GUIDE.md and CONTRIBUTING.md to include label meanings ([#4874](https://github.com/gkatsev/videojs-release-test/issues/4874)) ([a345971](https://github.com/gkatsev/videojs-release-test/commit/a345971))
* Update name of FullscreenToggle in documentation ([#4410](https://github.com/gkatsev/videojs-release-test/issues/4410)) ([9702155](https://github.com/gkatsev/videojs-release-test/commit/9702155))
* update player reference in advanced plugins doc ([#4622](https://github.com/gkatsev/videojs-release-test/issues/4622)) ([d8ea23e](https://github.com/gkatsev/videojs-release-test/commit/d8ea23e))
* update to width and height doc comments ([#4592](https://github.com/gkatsev/videojs-release-test/issues/4592)) ([006fb3b](https://github.com/gkatsev/videojs-release-test/commit/006fb3b))
* **coc:** introduce CODE_OF_CONDUCT.md ([#4160](https://github.com/gkatsev/videojs-release-test/issues/4160)) ([312b10c](https://github.com/gkatsev/videojs-release-test/commit/312b10c))
* **collaborator_guide:** add collaborator guide ([#3724](https://github.com/gkatsev/videojs-release-test/issues/3724)) ([8d51235](https://github.com/gkatsev/videojs-release-test/commit/8d51235))
* **COLLABORATOR_GUIDE:** how to release Video.js ([#4586](https://github.com/gkatsev/videojs-release-test/issues/4586)) ([9588602](https://github.com/gkatsev/videojs-release-test/commit/9588602))
* updates to faq, language guide, and minor edits ([#4556](https://github.com/gkatsev/videojs-release-test/issues/4556)) ([1f3375e](https://github.com/gkatsev/videojs-release-test/commit/1f3375e))
* **component:** Replace VolumeMenuButton with VolumePanel in component tree ([#4267](https://github.com/gkatsev/videojs-release-test/issues/4267)) ([02721c7](https://github.com/gkatsev/videojs-release-test/commit/02721c7)), closes [#4266](https://github.com/gkatsev/videojs-release-test/issues/4266)
* **contributing.md:** update CONTRIBUTING.md with latest info ([#3722](https://github.com/gkatsev/videojs-release-test/issues/3722)) ([11a096d](https://github.com/gkatsev/videojs-release-test/commit/11a096d))
* **faq:** add a question about autoplay ([#3898](https://github.com/gkatsev/videojs-release-test/issues/3898)) ([e5a240a](https://github.com/gkatsev/videojs-release-test/commit/e5a240a))
* **faq:** add FAQ question about RTMP url ([#3899](https://github.com/gkatsev/videojs-release-test/issues/3899)) ([9c74116](https://github.com/gkatsev/videojs-release-test/commit/9c74116))
* **FAQ:** add an faq ([#3805](https://github.com/gkatsev/videojs-release-test/issues/3805)) ([1d5562d](https://github.com/gkatsev/videojs-release-test/commit/1d5562d))
* **guides:** Manual Documentation Improvements ([#3703](https://github.com/gkatsev/videojs-release-test/issues/3703)) ([d24fe40](https://github.com/gkatsev/videojs-release-test/commit/d24fe40))
* **jsdoc:** introduce a jsdoc template and build on publish ([#3910](https://github.com/gkatsev/videojs-release-test/issues/3910)) ([e642295](https://github.com/gkatsev/videojs-release-test/commit/e642295))
* **jsdoc:** Update the jsdoc comments to modern syntax - Part 1 ([#3694](https://github.com/gkatsev/videojs-release-test/issues/3694)) ([1a0b281](https://github.com/gkatsev/videojs-release-test/commit/1a0b281))
* **jsdoc:** Update the jsdoc comments to modern syntax - Part 2 ([#3698](https://github.com/gkatsev/videojs-release-test/issues/3698)) ([cfc3ed7](https://github.com/gkatsev/videojs-release-test/commit/cfc3ed7))
* **jsdoc:** Update the jsdoc comments to modern syntax - Part 3 ([#3708](https://github.com/gkatsev/videojs-release-test/issues/3708)) ([eb2093e](https://github.com/gkatsev/videojs-release-test/commit/eb2093e))
* **jsdoc:** Update the jsdoc comments to modern syntax - Part 4  ([#3756](https://github.com/gkatsev/videojs-release-test/issues/3756)) ([15ce37e](https://github.com/gkatsev/videojs-release-test/commit/15ce37e))
* **react-guide:** Use a React component as a VJS component ([#4287](https://github.com/gkatsev/videojs-release-test/issues/4287)) ([cff2e50](https://github.com/gkatsev/videojs-release-test/commit/cff2e50))
* replace 'autoPlay' by 'autoplay' ([#4080](https://github.com/gkatsev/videojs-release-test/issues/4080)) ([7ab52d1](https://github.com/gkatsev/videojs-release-test/commit/7ab52d1)), closes [#3995](https://github.com/gkatsev/videojs-release-test/issues/3995)
* tech order will only have html5 by default ([#4188](https://github.com/gkatsev/videojs-release-test/issues/4188)) ([41be5dc](https://github.com/gkatsev/videojs-release-test/commit/41be5dc))
* **guide:** Add a `ModalDialog` guide ([#3961](https://github.com/gkatsev/videojs-release-test/issues/3961)) ([7b0d738](https://github.com/gkatsev/videojs-release-test/commit/7b0d738))
* **guides:** Add a basic ReactJS guide and update the FAQ ([#3972](https://github.com/gkatsev/videojs-release-test/issues/3972)) ([05b39fe](https://github.com/gkatsev/videojs-release-test/commit/05b39fe))
* **guides:** fix typos in faq guide ([#4067](https://github.com/gkatsev/videojs-release-test/issues/4067)) ([2433915](https://github.com/gkatsev/videojs-release-test/commit/2433915))
* **guides:** fix typos in functions guide ([#4035](https://github.com/gkatsev/videojs-release-test/issues/4035)) ([0fc2c1c](https://github.com/gkatsev/videojs-release-test/commit/0fc2c1c))
* **jsdoc:** Update the jsdoc comments to modern syntax - Part 5 ([#3766](https://github.com/gkatsev/videojs-release-test/issues/3766)) ([ba3cf17](https://github.com/gkatsev/videojs-release-test/commit/ba3cf17))
* **jsdoc:** Update the jsdoc comments to modern syntax - Part 6 ([#3771](https://github.com/gkatsev/videojs-release-test/issues/3771)) ([c902279](https://github.com/gkatsev/videojs-release-test/commit/c902279))
* **options.md:** Remove Bad Apostrophe ([#3677](https://github.com/gkatsev/videojs-release-test/issues/3677)) ([16c8559](https://github.com/gkatsev/videojs-release-test/commit/16c8559))
* **tech.md:** Add a note on Flash permissions in sandboxed environments ([#3684](https://github.com/gkatsev/videojs-release-test/issues/3684)) ([66922a8](https://github.com/gkatsev/videojs-release-test/commit/66922a8))
* **troubleshooting:** updates to troubleshooting doc ([#3912](https://github.com/gkatsev/videojs-release-test/issues/3912)) ([0ce7cd4](https://github.com/gkatsev/videojs-release-test/commit/0ce7cd4))
* Change registerSourceHandler param doc from first to index ([#3737](https://github.com/gkatsev/videojs-release-test/issues/3737)) ([b2c5b2a](https://github.com/gkatsev/videojs-release-test/commit/b2c5b2a))
* fix typo, extends -> extend ([#3789](https://github.com/gkatsev/videojs-release-test/issues/3789)) ([c5d1152](https://github.com/gkatsev/videojs-release-test/commit/c5d1152))
* wait for text track load with addRemoteTextTrack ([#4855](https://github.com/gkatsev/videojs-release-test/issues/4855)) ([7c393e5](https://github.com/gkatsev/videojs-release-test/commit/7c393e5))

### Performance Improvements

* Another 5ms of startup time improvements  ([#6145](https://github.com/gkatsev/videojs-release-test/issues/6145)) ([22782b8](https://github.com/gkatsev/videojs-release-test/commit/22782b8))
* Cache currentTime and buffered from Flash ([#3705](https://github.com/gkatsev/videojs-release-test/issues/3705)) ([45ffa81](https://github.com/gkatsev/videojs-release-test/commit/45ffa81))
* Do not add/remove listeners for each timer ([#6144](https://github.com/gkatsev/videojs-release-test/issues/6144)) ([5ee2477](https://github.com/gkatsev/videojs-release-test/commit/5ee2477))
* fix an event target memory leak ([#5855](https://github.com/gkatsev/videojs-release-test/issues/5855)) ([20bf42d](https://github.com/gkatsev/videojs-release-test/commit/20bf42d))
* Fix memory leaks in safari, edge, and ie ([#5880](https://github.com/gkatsev/videojs-release-test/issues/5880)) ([142cc67](https://github.com/gkatsev/videojs-release-test/commit/142cc67)), closes [#5878](https://github.com/gkatsev/videojs-release-test/issues/5878)
* fix more memory leaks ([#5860](https://github.com/gkatsev/videojs-release-test/issues/5860)) ([f01d6f4](https://github.com/gkatsev/videojs-release-test/commit/f01d6f4))
* Improve performance of toTitleCase, register with lower and TitleCase ([#6148](https://github.com/gkatsev/videojs-release-test/issues/6148)) ([266cb15](https://github.com/gkatsev/videojs-release-test/commit/266cb15))
* null out els on dispose to minimize detached els ([#4745](https://github.com/gkatsev/videojs-release-test/issues/4745)) ([2da7af1](https://github.com/gkatsev/videojs-release-test/commit/2da7af1)), closes [#4640](https://github.com/gkatsev/videojs-release-test/issues/4640)
* only update ui on change, wrap things in requestAnimationFrame ([#6155](https://github.com/gkatsev/videojs-release-test/issues/6155)) ([99b610b](https://github.com/gkatsev/videojs-release-test/commit/99b610b))
* Remove `playerEvent` and extra `timeupdate` handler in SeekBar ([#5852](https://github.com/gkatsev/videojs-release-test/issues/5852)) ([a2431ce](https://github.com/gkatsev/videojs-release-test/commit/a2431ce))
* save ~10ms on `player.src` call ([#6141](https://github.com/gkatsev/videojs-release-test/issues/6141)) ([2e495dd](https://github.com/gkatsev/videojs-release-test/commit/2e495dd))
* Save 3740 bytes gizpped by getting rid of xhr deps ([#6164](https://github.com/gkatsev/videojs-release-test/issues/6164)) ([bd58039](https://github.com/gkatsev/videojs-release-test/commit/bd58039))
* setTimeout and requestAnimationFrame memory leak ([#5294](https://github.com/gkatsev/videojs-release-test/issues/5294)) ([d7f27b7](https://github.com/gkatsev/videojs-release-test/commit/d7f27b7)), closes [#5199](https://github.com/gkatsev/videojs-release-test/issues/5199)
* throttle more timers and use native bind ([#6142](https://github.com/gkatsev/videojs-release-test/issues/6142)) ([6a93c8a](https://github.com/gkatsev/videojs-release-test/commit/6a93c8a))
* Use ES6 rest operator and allow V8 to optimize mergeOptions ([#3743](https://github.com/gkatsev/videojs-release-test/issues/3743)) ([5f42130](https://github.com/gkatsev/videojs-release-test/commit/5f42130))
* Use WeakMap for dom data ([#6103](https://github.com/gkatsev/videojs-release-test/issues/6103)) ([8610f99](https://github.com/gkatsev/videojs-release-test/commit/8610f99))
* **live-tracker:** disable live tracker on IE11 when document is hidden ([#5896](https://github.com/gkatsev/videojs-release-test/issues/5896)) ([511f729](https://github.com/gkatsev/videojs-release-test/commit/511f729)), closes [#5879](https://github.com/gkatsev/videojs-release-test/issues/5879)
* **player:** turn off all track list listeners on dispose ([#5867](https://github.com/gkatsev/videojs-release-test/issues/5867)) ([c632b24](https://github.com/gkatsev/videojs-release-test/commit/c632b24))
* **seek-bar:** don't update play progress when document is hidden ([#5879](https://github.com/gkatsev/videojs-release-test/issues/5879)) ([894dd9e](https://github.com/gkatsev/videojs-release-test/commit/894dd9e)), closes [#5575](https://github.com/gkatsev/videojs-release-test/issues/5575)
* Various small performance improvements. ([#4426](https://github.com/gkatsev/videojs-release-test/issues/4426)) ([77ba3d1](https://github.com/gkatsev/videojs-release-test/commit/77ba3d1))

### Reverts

* "fix: Allow evented objects, such as components and plugins, to listen to the window object in addition to DOM objects. ([#5255](https://github.com/gkatsev/videojs-release-test/issues/5255))" ([#5301](https://github.com/gkatsev/videojs-release-test/issues/5301)) ([361dc76](https://github.com/gkatsev/videojs-release-test/commit/361dc76)), closes [#5281](https://github.com/gkatsev/videojs-release-test/issues/5281)
* "fix(play-toggle): call event.stopPropagation in the click handler ([#5803](https://github.com/gkatsev/videojs-release-test/issues/5803))" ([#6128](https://github.com/gkatsev/videojs-release-test/issues/6128)) ([15ff8f7](https://github.com/gkatsev/videojs-release-test/commit/15ff8f7)), closes [#5624](https://github.com/gkatsev/videojs-release-test/issues/5624) [#6092](https://github.com/gkatsev/videojs-release-test/issues/6092)
* perf: Cache currentTime and buffered from Flash ([#3705](https://github.com/gkatsev/videojs-release-test/issues/3705)) ([#3778](https://github.com/gkatsev/videojs-release-test/issues/3778)) ([eb5e78b](https://github.com/gkatsev/videojs-release-test/commit/eb5e78b))
* Revert "fix: force autoplay in Chrome ([#4804](https://github.com/gkatsev/videojs-release-test/issues/4804))" ([#5009](https://github.com/gkatsev/videojs-release-test/issues/5009)) ([8d86afd](https://github.com/gkatsev/videojs-release-test/commit/8d86afd)), closes [#4720](https://github.com/gkatsev/videojs-release-test/issues/4720) [#5005](https://github.com/gkatsev/videojs-release-test/issues/5005) [#4720](https://github.com/gkatsev/videojs-release-test/issues/4720) [#5005](https://github.com/gkatsev/videojs-release-test/issues/5005)
* Revert "fix(iOS): pause player on suspend or stalled if extra buffer is available ([#6199](https://github.com/gkatsev/videojs-release-test/issues/6199))" ([#6373](https://github.com/gkatsev/videojs-release-test/issues/6373)) ([17d8046](https://github.com/gkatsev/videojs-release-test/commit/17d8046)), closes [#6330](https://github.com/gkatsev/videojs-release-test/issues/6330)

### Tests

* add Edge to browserstack tests ([#3834](https://github.com/gkatsev/videojs-release-test/issues/3834)) ([5ec46b0](https://github.com/gkatsev/videojs-release-test/commit/5ec46b0))
* add project and build names to browserstack ([#4903](https://github.com/gkatsev/videojs-release-test/issues/4903)) ([41fd5cb](https://github.com/gkatsev/videojs-release-test/commit/41fd5cb))
* add tests for obj.assign util ([#4014](https://github.com/gkatsev/videojs-release-test/issues/4014)) ([fcb5aa8](https://github.com/gkatsev/videojs-release-test/commit/fcb5aa8))
* add unit tests for player.duration() ([#4459](https://github.com/gkatsev/videojs-release-test/issues/4459)) ([1e80e59](https://github.com/gkatsev/videojs-release-test/commit/1e80e59))
* check dom-data to verify we aren't leaking memory and event handlers ([#5862](https://github.com/gkatsev/videojs-release-test/issues/5862)) ([6e173b0](https://github.com/gkatsev/videojs-release-test/commit/6e173b0))
* clean up test warnings ([#4752](https://github.com/gkatsev/videojs-release-test/issues/4752)) ([3aae4b2](https://github.com/gkatsev/videojs-release-test/commit/3aae4b2))
* fix IE9 rounding issue with lastvolume test ([#4230](https://github.com/gkatsev/videojs-release-test/issues/4230)) ([46dd0aa](https://github.com/gkatsev/videojs-release-test/commit/46dd0aa)), closes [#4227](https://github.com/gkatsev/videojs-release-test/issues/4227)
* fix modal dialog test for showing controls ([#4707](https://github.com/gkatsev/videojs-release-test/issues/4707)) ([45a6b30](https://github.com/gkatsev/videojs-release-test/commit/45a6b30)), closes [#4690](https://github.com/gkatsev/videojs-release-test/issues/4690) [#4706](https://github.com/gkatsev/videojs-release-test/issues/4706)
* fix tests ([#3953](https://github.com/gkatsev/videojs-release-test/issues/3953)) ([7bafcc2](https://github.com/gkatsev/videojs-release-test/commit/7bafcc2))
* fix tests on older IE ([#3800](https://github.com/gkatsev/videojs-release-test/issues/3800)) ([b4ebd9b](https://github.com/gkatsev/videojs-release-test/commit/b4ebd9b))
* fix travis ci issues with resize-manager tests ([#5390](https://github.com/gkatsev/videojs-release-test/issues/5390)) ([3744df1](https://github.com/gkatsev/videojs-release-test/commit/3744df1))
* get rid of redundant test logging ([#4682](https://github.com/gkatsev/videojs-release-test/issues/4682)) ([983a573](https://github.com/gkatsev/videojs-release-test/commit/983a573))
* memory leak fixes in tests ([#5861](https://github.com/gkatsev/videojs-release-test/issues/5861)) ([23a36f3](https://github.com/gkatsev/videojs-release-test/commit/23a36f3))
* no longer test on IE8, IE9, or IE10 ([#5032](https://github.com/gkatsev/videojs-release-test/issues/5032)) ([0a20d65](https://github.com/gkatsev/videojs-release-test/commit/0a20d65))
* restore prototype modifications and fix flaky tests ([#5964](https://github.com/gkatsev/videojs-release-test/issues/5964)) ([a55c51f](https://github.com/gkatsev/videojs-release-test/commit/a55c51f))
* run tests via rollup ([#5601](https://github.com/gkatsev/videojs-release-test/issues/5601)) ([4134a97](https://github.com/gkatsev/videojs-release-test/commit/4134a97))
* silence test logs ([#6165](https://github.com/gkatsev/videojs-release-test/issues/6165)) ([9d2e5f3](https://github.com/gkatsev/videojs-release-test/commit/9d2e5f3))
* update karma browser OS versions ([#5050](https://github.com/gkatsev/videojs-release-test/issues/5050)) ([3798446](https://github.com/gkatsev/videojs-release-test/commit/3798446))
* verify null-checks with player and control bar children set to false ([#5670](https://github.com/gkatsev/videojs-release-test/issues/5670)) ([13b42ad](https://github.com/gkatsev/videojs-release-test/commit/13b42ad))
* **a11y:** add basic accessibility testing using grunt-accessibility ([7d85f27](https://github.com/gkatsev/videojs-release-test/commit/7d85f27))
* **dom:** fix removeElClass test in Safari 10. ([#3768](https://github.com/gkatsev/videojs-release-test/issues/3768)) ([9965077](https://github.com/gkatsev/videojs-release-test/commit/9965077))
* **events:** silence error logging in tests ([#3835](https://github.com/gkatsev/videojs-release-test/issues/3835)) ([214e01c](https://github.com/gkatsev/videojs-release-test/commit/214e01c))
* **hooks:** fix hooks unit test in ie8 ([#3745](https://github.com/gkatsev/videojs-release-test/issues/3745)) ([e9e5b5f](https://github.com/gkatsev/videojs-release-test/commit/e9e5b5f))
* **hooks:** move vjs hooks QUnit module into separate file ([#3862](https://github.com/gkatsev/videojs-release-test/issues/3862)) ([87cd26d](https://github.com/gkatsev/videojs-release-test/commit/87cd26d))
* **hooks:** remove errors logged in tests ([#3865](https://github.com/gkatsev/videojs-release-test/issues/3865)) ([3f724f9](https://github.com/gkatsev/videojs-release-test/commit/3f724f9))
* **ResizeManager:** only listen for one playerresize to make test not flaky ([#5022](https://github.com/gkatsev/videojs-release-test/issues/5022)) ([4e83cd3](https://github.com/gkatsev/videojs-release-test/commit/4e83cd3))
* update tests to use qunit 2 assert format ([#4753](https://github.com/gkatsev/videojs-release-test/issues/4753)) ([06641e8](https://github.com/gkatsev/videojs-release-test/commit/06641e8))
* warning, if the element is not in the DOM ([#4723](https://github.com/gkatsev/videojs-release-test/issues/4723)) ([c213737](https://github.com/gkatsev/videojs-release-test/commit/c213737)), closes [#4698](https://github.com/gkatsev/videojs-release-test/issues/4698)
* **ie8:** only run mute toggle tests in html5 env ([#4003](https://github.com/gkatsev/videojs-release-test/issues/4003)) ([5bde16a](https://github.com/gkatsev/videojs-release-test/commit/5bde16a))
* **TextTrackDisplay:** Removing incorrect test techOrder ([#4379](https://github.com/gkatsev/videojs-release-test/issues/4379)) ([eade52e](https://github.com/gkatsev/videojs-release-test/commit/eade52e))
